    ...
    <div class="b46productpage">
        <div class="container">
            <h1>Reward Checking</h1>
                <img src="{{asset('assets/frontend/contentassets/284b24dba570457b88f70d1510b89a40/1.1.2_b-46-subpage-hero_01_benefits_maturewoman.png')}}" alt="First PREMIER Bank">
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/9977809429c54f419f94186bd528b1b3/1.1.2_b-16-list01_alternating-1_checkladyhand.png')}}" title="The Basics" alt="hand writing check"></div>
                        </div>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/ff0adc7c17334b8d8cb110238a36bbd3/1.1.2_b-16-list01_alternating-2_maturewoman.png')}}" title="FREE" alt="woman depositing check with mobile phone"></div>
        ...
        <div class="b16basic_box_left_content b16basic_box_background">
            <div class="b16basic_box_main">
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/203e85d02df74fe982e1bfac350dfd14/1.1.2_b-16-list01_alternating-3_guyoperator.png')}}" title="Fraud Prevention" alt="man wearing headset"></div>
                        </div>
                        <div class="b16basic_box_left">
        ...
        <div class="container">
            ...
            <div class="b17free_mobile_banking_right">
                ...
                <div class="b17free_mobile_banking_left right">
                    <img class="img-responsive" id="imgMainImage" style="border-radius:50%" src="{{asset('assets/frontend/contentassets/e584089a87e142d49159064b1aecc095/b-17_promo_01_personal_debit_card.jpg')}}" alt="First PREMIER Bank">
                </div>
        </div>
    </div>

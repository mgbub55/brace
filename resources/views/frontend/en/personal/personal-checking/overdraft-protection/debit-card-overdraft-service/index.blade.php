...
@section('content')
    ...
    <title>Debit Card Overdraft Service– Personal Checking |First PREMIER Bank</title>
...
<body class="eupopup eupopup-bottom    page-debit-card-overdraft-service parent-6251">
...
<section class="row-full">
    <div class="b44header">
        <div class="container">
            <h1>Debit Card Overdraft Service</h1>
...
<ul>
        ...
        <li>
            <a href="../index.html">Overdraft Protection</a>
        </li>

        <li>
            <a href="index.html">Debit Card Overdraft Service</a>
        </li>
...
<section class="row-full b4background">
    <div class="container">
        <div class="b4anywhere_banking" style="width:100%; ">
                                        <div class="xhtml"><div id="myModalfAtLr" class="modal fade" style="display: none;" role="dialog">
<div class="modal-dialog speedpop_board">
<div class="modal-content">
<div class="modal-body">
<div class="speedpop_main_container_board"><button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"> <img class="close_icon" src="../../../../../static/img/CloseTable.png" alt="First PREMIER Bank" /></span></button>
<div class="pop_main_container">
<h4 class="popupheader">Cancel</h4>
<p>You must already be signed up for Debit Card Overdraft Service to cancel.<br /><br />Do you want to proceed?</p>
<br /><br /><br /><a class="speedbumpgreenbutton" href="../debit-card-overdraft-service-cancellation/index076b.html?cancel=1" rel="noopener">Yes, Please Continue</a></div>
</div>
</div>
</div>
</div>
</div>
<div id="myModalfBDvQ" class="modal fade" style="display: none;" role="dialog">
<div class="modal-dialog speedpop_board" style="height: 400px;">
<div class="modal-content">
<div class="modal-body">
<div class="speedpop_main_container_board"><button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"> <img class="close_icon" src="../../../../../static/img/CloseTable.png" alt="First PREMIER Bank" /></span></button>
<div class="pop_main_container">
<h4 class="popupheader">Important Information</h4>
<p>Thank you for your interest in Debit Card Overdraft Service. Before enrolling please note:<br /><br />1. This will authorize First PREMIER Bank to pay overdrafts on your ATM and everyday debit card transactions.<br /><br />2. This will not access credit cards. To access your credit card account, go to www.mypremiercreditcard.com.<br /><br />3. We do not accept or process enrollments from children under the age of 18.<br /><br /><br /></p>
<a class="speedbumpgreenbutton" href="../debit-card-overdraft-service-disclosure/index.html" rel="noopener">I Understand, Please Continue</a></div>
</div>
</div>
</div>
</div>
...
<p>&nbsp;</p>
<p>Some banks have made the decision to simply decline all ATM and everyday (one-time) debit card transactions that have insufficient funds. This situation can be inconvenient and embarrassing for an individual. At First PREMIER Bank we believe you should have a choice. We understand that an overdraft on an account can happen for a variety of reasons. That's why we encourage you to sign up for our Debit Card Overdraft Service. The choice is up to you!</p>
<h3>&nbsp;</h3>
<h3>Choice #1 - Sign up for Debit Card Overdraft Service</h3>
<p>&nbsp;</p>
<p>If you add this service to your personal deposit account, First PREMIER Bank may approve (authorize), at our discretion, up to $500 beyond your available balance for ATM and everyday (one-time) debit card transactions<sup>1</sup>. Choice #1 doesn't cost anything unless you find yourself in a situation where you need it. The debit card ATM and point of sale daily limits still apply.</p>
<p>&nbsp;</p>
<p>Here is how it works. If you are at the grocery store and swipe your debit card at the checkout to purchase $100 worth of groceries, but your balance on record is only $50, we can make the decision to allow your purchase to go through. This saves you the inconvenience and embarrassment of declining your card. We would charge you a $34 overdraft fee for this debit card transaction.</p>
<p>&nbsp;</p>
<p><a class="speedbumpgreenbutton" href="#" data-toggle="modal" data-target="#myModalfBDvQ">Sign Up</a><br /><br /></p>
<h3><br />Choice #2 - Choose to do nothing (decline Debit Card Overdraft Service)</h3>
<p>If you do not enroll, First PREMIER Bank will decline any ATM withdrawals and debit card purchases that would overdraw your account when you do not have the sufficient funds to cover it.</p>
<p><br />If you would like to cancel Debit Card Overdraft Service, please click the Cancel button below.</p>
<p><br /><a class="speedbumpgreenbutton" href="#" data-toggle="modal" data-target="#myModalfAtLr">Cancel</a></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
                    </div>
...
<section class="row-full">
        <div class="b13what_you_know_main">
            <div class="container" style="background-color:#182e39 !important;">
                ...
                <h4> Disclosure </h4>
                <div class="b13points">
                    <p>{1} We will charge you a fee of $34 each time we pay an overdraft on ATM and everyday debit card transactions. We will also charge a continuous overdraft fee for $5 per business day.&nbsp; There is no limit on the total fees we can charge you for overdrawing your account.&nbsp; Overdrafts are payable upon demand.</p>
                </div>
            </div>
        </div>
</section></div></div>

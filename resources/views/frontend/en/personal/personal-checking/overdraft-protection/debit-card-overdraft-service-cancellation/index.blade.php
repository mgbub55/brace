...
@section('content')
    ...
    <title>Overdraft Service Cancellation - Personal Checking |First PREMIER Bank</title>
...
<body class="eupopup eupopup-bottom    page-debit-card-overdraft-service-cancellation parent-6251">
...
<a href="../../debit-card/index.html">Debit Card</a>                                                </div>
                                                <div class="panel-body">
<a href="../index.html">Overdraft Protection</a>                                                </div>
                                                <div class="panel-body">
                                                ...
                                                <div class="container">
                                                        ...
                                                        <div class="">
                                                            <div class="menu_left_section_main bg-menu_left_section_main col-md-12 col-sm-12 col-xs-12">
                                                                    ...
                                                                    <div class="bg-menu_left_section col-md-6 col-xs-12 col-sm-6">
                                                                        <div class="subsubitem"><a href="../index.html">Overdraft Protection</a></div>
...
<div class="row equal-height"><div class="block b50block  col-md-12">

<style>
    .b50hero {position:relative;height:377px;overflow-y:hidden;overflow-x:hidden;}

    .b50hero_background {
        position:absolute;
        background: url("../../../../../globalassets/images/backgrounds/b-44-grey.png#svgView(preserveAspectRatio(none))") center center no-repeat;
        background-size: 100% 100%;
        overflow-y:hidden;
    }
    .b50hero_text {position:relative; z-index:99;top:25%;}
...
<section class="row-full">
    <div class="container">
        <div class="b50hero">
            <svg class="b50hero_background"></svg>
            <div class="b50hero_text">
                <h1>Debit Card Overdraft Service Cancellation</h1>
            </div>
        </div>
    </div>
</section></div><div class="block debitcardoverdraftblock  col-md-12">
<style>
    .field-validation-error { color:#ca2139; font-weight:bolder; }
    span.input-group-addon { background-image: linear-gradient(180deg, rgba(37,69,90,1) 0%, rgba(48,89,116,1) 49%, rgba(60,111,145,1) 100%); color: #fff; }
</style>
<form action="https://www.firstpremier.com/DebitCardOverdraftFormBlock/Save" method="post" style="padding-left:30px;">    <div class="row">
        <div class="col-xs-12">
            <p>To enroll in <a title="Debit Card Overdraft Service" href="../debit-card-overdraft-service/index.html">Debit Card Overdraft Service</a>, simply complete the application below, and a representative from First PREMIER will contact you by email within two business days.<br /><br /></p>
<p>&nbsp;</p>
<p><strong>As a reminder, this coverage applies to ATM withdrawals and debit card purchases only.&nbsp; It does not apply to purchases made on your credit card.</strong>&nbsp; If you would like to access your credit card account, <a title="you may do so here" href="https://www.mypremiercreditcard.com/">you may do so here</a>.</p>
<p>&nbsp;</p>
<p>When completing the form, note all fields are required EXCEPT "middle initial."</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-2">
            <div class="form-group">
                <h5><label for="MiddleInitial">Middle Initial</label></h5>
                <input class="form-control initial-mask" id="MiddleInitial" name="MiddleInitial" type="text" value="" />
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-4">
            <div class="form-group">
                <h5><label for="CurrentAddress">Address</label></h5>
                <input class="form-control" data-val="true" data-val-required="Please enter an address." id="CurrentAddress" name="CurrentAddress" type="text" value="" />
                <span class="field-validation-valid" data-valmsg-for="CurrentAddress" data-valmsg-replace="true"></span>
            </div>
        </div>
        <div class="col-xs-12 col-sm-4">
            <div class="form-group">
                <h5><label for="City">City</label></h5>
                <input class="form-control" data-val="true" data-val-required="Please enter a city." id="City" name="City" type="text" value="" />
        ...
        <div class="col-xs-12 col-sm-2">
            <div class="form-group">
                ...
                <select class="form-control" data-val="true" data-val-regex="Please enter a valid zip code" data-val-regex-pattern="^(?i:A[LKSZRAEP]|C[AOT]|D[EC]|F[LM]|G[AU]|HI|I[ADLN]|K[SY]|LA|M[ADEHINOPST]|N[CDEHJMVY]|O[HKR]|P[ARW]|RI|S[CD]|T[NX]|UT|V[AIT]|W[AIVY])$" data-val-required="Please enter a state." id="State" name="State"><option value="AL">AL</option>
...
<option value="WY">WY</option>
        ...
        <div class="col-xs-12 col-sm-2">
            <div class="form-group">
                ...
                <input class="form-control zip-mask" data-val="true" data-val-required="Please enter a valid zip code." id="Zip" name="Zip" type="text" value="" />
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-4">
            <div class="form-group">
                <h5><label for="DayTimePhone">Daytime Phone</label></h5>
                <input class="form-control phone-mask" data-val="true" data-val-required="Daytime phone required" id="DayTimePhone" name="DayTimePhone" type="text" value="" />
                <span class="field-validation-valid" data-valmsg-for="DayTimePhone" data-valmsg-replace="true"></span>
            </div>
        </div>
        <div class="col-xs-12 col-sm-4">
            <div class="form-group">
                <h5><label for="EveningPhone">Evening Phone</label></h5>
                <input class="form-control phone-mask" data-val="true" data-val-required="Evening phone required" id="EveningPhone" name="EveningPhone" type="text" value="" />
                <span class="field-validation-valid" data-valmsg-for="EveningPhone" data-valmsg-replace="true"></span>
            </div>
        </div>
        <div class="col-xs-12 col-sm-4">
            <div class="form-group">
                <h5><label for="SocialSecurityNumber">Social Security Number</label></h5>
                <input class="form-control ssn-mask" data-val="true" data-val-required="Please enter a valid social security number." id="SocialSecurityNumber" name="SocialSecurityNumber" type="text" value="" />
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-4">
            <div class="form-group">
                <h5><label for="DateOfBirth">Date of Birth</label></h5>
                <input class="form-control date-mask" data-val="true" data-val-date="The field Date of Birth must be a date." data-val-required="Please enter a valid date of birth." id="DateOfBirth" name="DateOfBirth" type="text" value="" />
                <span class="field-validation-valid" data-valmsg-for="DateOfBirth" data-valmsg-replace="true"></span>
            </div>
        </div>
        <div class="col-xs-12 col-sm-4">
            <div class="form-group">
                <h5><label for="EmailAddress">Email Address</label></h5>
                <input class="form-control" data-val="true" data-val-regex="E-mail is not valid" data-val-regex-pattern="^[a-zA-Z0-9_\.-]+@([a-zA-Z0-9-]+\.)+[a-zA-Z]{2,6}$" data-val-required="Please enter an email address." id="EmailAddress" name="EmailAddress" type="text" value="" />
                <span class="field-validation-valid" data-valmsg-for="EmailAddress" data-valmsg-replace="true"></span>
            </div>
        </div>
        <div class="col-xs-12 col-sm-4">
            <div class="form-group">
                <h5><label for="ConfirmEmailAddress">Confirm Email Address</label></h5>
                <input class="form-control" data-val="true" data-val-equalto="Emails do not match" data-val-equalto-other="*.EmailAddress" data-val-regex="E-mail is not valid" data-val-regex-pattern="^[a-zA-Z0-9_\.-]+@([a-zA-Z0-9-]+\.)+[a-zA-Z]{2,6}$" data-val-required="Please enter an email address." id="ConfirmEmailAddress" name="ConfirmEmailAddress" type="text" value="" />
    ...
    <div class="row">
        <div class="col-xs-12">
            <span class="field-validation-valid" data-valmsg-for="AccountNumbers" data-valmsg-replace="true"></span>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12 col-sm-6">
            <h5><strong><label for="AccountNumbers">Account Numbers</label></strong></h5>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" id="account-1">1.</span>
                        <input type="text" class="form-control" name="AccountNumbers" aria-describedby="account-1" />
                    </div>
                    <span class="field-validation-valid" data-valmsg-for="AccountNumbers1" data-valmsg-replace="true"></span>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" id="account-2">2.</span>
                        <input type="text" class="form-control" name="AccountNumbers" aria-describedby="account-2" />
                    </div>
                    <span class="field-validation-valid" data-valmsg-for="AccountNumbers2" data-valmsg-replace="true"></span>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" id="account-3">3.</span>
                        <input type="text" class="form-control" name="AccountNumbers" aria-describedby="account-3" />
                    </div>
                    <span class="field-validation-valid" data-valmsg-for="AccountNumbers3" data-valmsg-replace="true"></span>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" id="account-4">4.</span>
                        <input type="text" class="form-control" name="AccountNumbers" aria-describedby="account-4" />
                    </div>
                    <span class="field-validation-valid" data-valmsg-for="AccountNumbers4" data-valmsg-replace="true"></span>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" id="account-5">5.</span>
                        <input type="text" class="form-control" name="AccountNumbers" aria-describedby="account-5" />
                    </div>
                    <span class="field-validation-valid" data-valmsg-for="AccountNumbers5" data-valmsg-replace="true"></span>
                </div>
        ...
        <div class="col-xs-12 col-sm-6">
            <h5><strong><label for="AccountNumbers">Account Numbers</label></strong></h5>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" id="account-6">6.</span>
                        <input type="text" class="form-control" name="AccountNumbers" aria-describedby="account-6" />
                    </div>
                    <span class="field-validation-valid" data-valmsg-for="AccountNumbers6" data-valmsg-replace="true"></span>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" id="account-7">7.</span>
                        <input type="text" class="form-control" name="AccountNumbers" aria-describedby="account-7" />
                    </div>
                    <span class="field-validation-valid" data-valmsg-for="AccountNumbers7" data-valmsg-replace="true"></span>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" id="account-8">8.</span>
                        <input type="text" class="form-control" name="AccountNumbers" aria-describedby="account-8" />
                    </div>
                    <span class="field-validation-valid" data-valmsg-for="AccountNumbers8" data-valmsg-replace="true"></span>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" id="account-9">9.</span>
                        <input type="text" class="form-control" name="AccountNumbers" aria-describedby="account-9" />
                    </div>
                    <span class="field-validation-valid" data-valmsg-for="AccountNumbers9" data-valmsg-replace="true"></span>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon" id="account-10">10.</span>
                        <input type="text" class="form-control" name="AccountNumbers" aria-describedby="account-10" />
                    </div>
                    <span class="field-validation-valid" data-valmsg-for="AccountNumbers10" data-valmsg-replace="true"></span>
                </div>
        </div>
    </div>
<input data-val="true" data-val-required="The CancelOverdraft field is required." id="CancelOverdraft" name="CancelOverdraft" type="hidden" value="False" /><input id="CurrentPageLink" name="CurrentPageLink" type="hidden" value="24953" /><input id="CurrentLanguage" name="CurrentLanguage" type="hidden" value="en" /><input id="CurrentBlockLink" name="CurrentBlockLink" type="hidden" value="24955" />    <button type="submit" class="btn btn-primary">Submit</button>
<a class="btn btn-primary" href="../index.html">Cancel</a></form></div></div>

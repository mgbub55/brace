...
@section('content')
    ...
    <title>Overdraft Service Disclosure - Personal Checking |First PREMIER Bank</title>
...
<body class="eupopup eupopup-bottom    page-debit-card-overdraft-service-disclosure parent-6251">
...
<section class="row-full">
    <div class="b44header">
        <div class="container">
            <h1>Overdraft Service Disclosure</h1>
...
<ul>
        ...
        <li>
            <a href="index.html">Debit Card Overdraft Service Disclosure</a>
        </li>
...
<section class="row-full b4background">
    <div class="container">
        <div class="b4anywhere_banking" style="width:100%; ">
                                        <div class="xhtml"><h3>PLEASE READ BEFORE ENROLLING IN FIRST PREMIER BANK'S DEBIT CARD OVERDRAFT SERVICE</h3>
<p>&nbsp;</p>
<p>An overdraft occurs when you do not have enough money in your account to cover a transaction, but we pay it anyway. We can cover your overdrafts in two different ways:<br /><br /></p>
<p>1. We have standard overdraft practices that come with your account.</p>
<p>2. We also offer overdraft protection plans, such as a link to Lines of Credit, which may be less expensive than our standard overdraft practices. To learn more, ask us about these plans.</p>
<p>&nbsp;</p>
<p>This notice explains our standard overdraft practices.</p>
<p><br /><br /><strong>WHAT ARE THE STANDARD OVERDRAFT PRACTICES THAT COME WITH MY ACCOUNT?<br /><br /></strong></p>
<p>We do authorize and pay overdrafts for the following types of transactions:<br /><br /></p>
<ul>
<li>Checks and other transactions made using your checking account number</li>
<li>Automatic bill payments</li>
</ul>
<p>&nbsp;</p>
<p>We do not authorize and pay overdrafts for the following types of transactions unless you ask us to (see below):<br /><br /></p>
<ul>
<li>ATM transactions</li>
<li>Everyday debit (check) card transactions</li>
</ul>
<p>&nbsp;</p>
...
<p><br /><br /><strong>WHAT FEES WILL I BE CHARGED IF FIRST PREMIER BANK PAYS MY OVERDRAFT?</strong></p>
<p><br />Under our standard overdraft practices:<br /><br /></p>
<ul>
<li>We will charge you a fee of up to $34 each time we pay an overdraft.</li>
<li>Also, we will charge a continuous overdraft fee of $5 per business day.</li>
<li>There is no limit on the total fees we can charge you for overdrawing your account.</li>
<li>Overdrafts are payable upon demand.</li>
</ul>
<p>&nbsp;</p>
<p><br /><strong>WHAT IF I WANT FIRST PREMIER BANK TO AUTHORIZE AND PAY OVERDRAFTS ON MY ATM AND EVERDAY DEBIT CARD TRANSACTIONS?</strong></p>
<p><br />All standard overdraft practices and fees will apply, including a fee of $34 each time we pay an overdraft on ATM and everyday debit card transactions.</p>
<p><br />If you want us to authorize and pay overdrafts on ATM and everyday debit card transactions you may sign up any of these ways:<br /><br /></p>
<ul>
<li>Visit with a First PREMIER Banker</li>
<li>Contact Us</li>
<li>Sign up online</li>
</ul>
<p>&nbsp;</p>
<p><br />By accepting below I authorize First PREMIER Bank to pay overdrafts on my ATM and everyday debit card transactions.</p>
<p>&nbsp;</p>
<p><a class="btnGreen" href="../debit-card-overdraft-service-form/index.html">Accept</a>&nbsp;&nbsp;<a href="../debit-card-overdraft-service/index.html">Decline</a></p>
<p>&nbsp;</p>
<p><br /><br /><br /><br /></p></div>
                    </div>
    </div>

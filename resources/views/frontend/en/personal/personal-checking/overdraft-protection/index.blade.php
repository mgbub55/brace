...
@section('content')
    ...
    <title>Overdraft Protection - Personal Checking | First PREMIER Bank</title>
            <meta name="description" content="Learn about First PREMIER&#39;s personal overdraft protection options, which can help ensure funds are in place to cover payments and purchases." />
...
<body class="eupopup eupopup-bottom    page-overdraft-protection parent-6094">
    ...
    <div class="b46productpage">
        <div class="container">
            <h1>Overdraft Protection</h1>
                <img src="{{asset('assets/frontend/contentassets/7db064c5520a4f26847d178e8daefe0c/1.1.4-b-46-subpage-hero-01-benefits-womanshopping.png')}}" alt="First PREMIER Bank">
                            <h2>Overdraft Services</h2>
            <p>Ensure your account has sufficient funds to cover payments and purchases and avoid the embarrassment of declined transactions.</p>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/70269c2575f445138f0bd6dbcb43c83e/1.1.4-b-16-list-01-alternating-1-coupleshopping.png')}}" title="Overdraft Protection" alt="couple walking on busy street"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>Overdraft Protection</h2>

                                <div class="xhtml"><p style="text-align: left;">Link your personal checking account to a <a href="../../savings-and-cds/regular-savings/index.html">Regular Savings</a>, <a href="../../savings-and-cds/premier-money-market/index.html">PREMIER Money Market</a> or an eligible <a href="../../loans-and-credit-lines/index.html">Line of Credit</a>. A $12 Overdraft Protection Transfer Fee will be assessed every time the bank automatically transfers the available funds. This fee does not apply to Reward Checking customers or to any manual transfer, which is completed online, in person or by calling Customer Care.&nbsp;To add overdraft protection to your account, speak to a personal banker.</p></div>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/460c82b36dd4413d9e386f1e1eab6a7b/1.1.4-b-16-list-01-alternating-2-manshopping.png')}}" title="Debit Mastercard&#174; Overdraft Service" alt="man walking with shopping bags on mobile phone"></div>

                        </div>
                        <div class="b16basic_box_left payIcon-space">
                            <h2 style="padding-top:0px !important;">Debit Mastercard&#174; Overdraft Service</h2>
                                <div class="xhtml"><p style="text-align: left;">By choosing to add this service to an account, we may approve transactions, beyond your available balance for ATM and everyday Debit Mastercard transactions<sup>1</sup>. If this service is not added, we will decline all ATM and everyday Debit Mastercard transactions that do not have sufficient funds.</p></div>

                            <!-- Button and Footer Links go here ... -->
                                        <a href="debit-card-overdraft-service/index.html" class="b16readmore">Enroll Now</a>
                            <!-- Button and Footer Links go here ... -->
                        </div>
                    </div>
                </div>
...
<section>
    <div class="b18great_feature_main">
        <h2> Additional Tips to Avoid Overdrafts </h2>
        <div class="b18great_feature_left">
                            <div class="b18detail xhtml"><ul>
<li>Use direct deposit to ensure your paycheck is deposited faster</li>
<li>Keep a sufficient cushion to cover anticipated expenses</li>
<li>Forecast spending around automatic bill and loan payments</li>
</ul></div>
                                </div>
        <div class="b18great_feature_left b18great_feature_right payIcon-space">
                            <div class="b18detail xhtml"><ul>
<li>Monitor account activity with text and email alerts</li>
<li>Check your balance real-time via online and mobile banking<br /><br /><br /><br /></li>
</ul>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CALL US (800) 501-6535</p>
<p>&nbsp;</p></div>
                                </div>
        <div class="clearfix">
            <center>
                            <a href="../../../pages/quick-links/customer-care/index.html" class="btnGreen">Contact Us</a>
            </center>
        </div>

    </div>
    <div id="a58012925" class="modal fade" role="dialog">
    ...
    <div id="b58012925" class="modal fade" role="dialog">
        <div class="modal-dialog pop_board">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="pop_main_container_board">
    ...
    <div id="c58012925" class="modal fade" role="dialog">
        <div class="modal-dialog pop_board">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="pop_main_container_board">
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="padding-left:40px;">
                                        ...
                                        <div class="b46Blue" style="text-align:left;">
                                            ...
                                            <p><br /><a href="../../../pages/quick-links/customer-care/index.html" target="_blank"></a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<section class="row-full b17promo">
    ...
    <div class="b17free_mobile_banking ">
        <div class="container">
            <h2>FREE Online & Mobile Banking</h2>

            <div class="b17free_mobile_banking_right">
                    <h3>Stay on Top of Your Accounts, Anywhere</h3>
                                <div class="xhtml"><ul>
<li>Check balances, monitor spending and manage bills&nbsp;&nbsp;</li>
<li>Deposit checks via mobile phone</li>
<li>Lock and unlock a lost or stolen debit card&nbsp;</li>
<li>Plan your budget with spending analysis tools</li>
</ul></div>
                ...
                <div class="b17free_mobile_banking_left right">
                    <img class="img-responsive" id="imgMainImage" style="border-radius:50%" src="{{asset('assets/frontend/contentassets/60d9297d3db44001a2888322a3d6f45a/1.1.4_b-17-text-with-image_malecchand.png')}}" alt="First PREMIER Bank">
                </div>
        </div>
    </div>


    <div id="a18878830" class="modal fade" role="dialog">
        <div class="modal-dialog pop_board">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="pop_main_container_board">
...
<script>
    $('.modal-backdrop').remove();
            ...
            .b12faq_main { float: left; width: 100%; padding:0px 0px 50px 0px !important; text-align: left; background: #fff; }
        </style>
            ...
            <div class="b12container">
                ...
                <div class="tabbable">
                    <div class="tab-content col-md-7">
                        <div class="tab-pane active" id="A"><span>What is an overdraft?</span><p><p>Overdrafts occur when you spend more money that you have in your checking account.</p></p></div><div class="tab-pane" id="B"><span>How can I avoid overdrafts?</span><p><p>To avoid account overdrafts, here are some useful tips:<br />&bull; Use direct deposit to ensure your paycheck is deposited faster&nbsp;<br />&bull; Monitor account activity with email and SMS account alerts <br />&bull; Check your balance real-time via <a href="../../online-and-mobile/index.html">Online and Mobile Banking</a><br />&bull; Use a First PREMIER Bank savings account or line of credit for <a href="index.html">overdraft protection</a> so you have it when you need it most</p></p></div><div class="tab-pane" id="C"><span>Which type of overdraft coverage do I need?</span><p><p>The type of overdraft coverage depends on what type of protection you're looking for: <br />&bull; Savings Overdraft Protection - coverage will depend on the available funds in your linked savings account&nbsp;<br />&bull; Line of Credit Overdraft Protection - coverage will depend on the available credit in your linked credit line</p></p></div><div class="tab-pane" id="D"><span>Why does First PREMIER Bank offer Debit Card Overdraft Service?</span><p><p>An individual can find themselves in a situation where they don&rsquo;t have enough money in their account to cover a debit card transaction. At First PREMIER Bank, we believe you should have a choice. To avoid what could be a potentially embarrassing situation, we encourage you to sign up for our Debit Card Overdraft Service.</p></p></div>
                    </div>
                    <ul class="nav nav-pills nav-stacked col-md-5">
                        <li class="active"><a href="#A" data-toggle="tab">What is an overdraft?</a></li><li><a href="#B" data-toggle="tab">How can I avoid overdrafts?</a></li><li><a href="#C" data-toggle="tab">Which type of overdraft coverage do I need?</a></li><li><a href="#D" data-toggle="tab">Why does First PREMIER Bank offer Debit Card Overdraft Service?</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="row-full">
        <div class="b13what_you_know_main">
            <div class="container" style="background-color:#182e39 !important;">
                ...
                <h4> Disclosures </h4>
                <div class="b13points">
                    <p>{1} We will charge you a fee of $34 each time we pay an overdraft on ATM and everyday debit card transactions. We will also charge a continuous overdraft fee of $5 per business day. There is no limit on the total fees we can charge you for overdrawing your account. Overdrafts are payable upon demand.</p>
                </div>
            </div>
        </div>
</section></div></div>

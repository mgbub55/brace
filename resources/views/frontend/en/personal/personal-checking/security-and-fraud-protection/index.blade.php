                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="{{ asset('assets/frontend/contentassets/0a5ab5dcc3ef419dbc577e7199b6830d/1.1.5_b-46-subpage-hero-01-benefits_womanoutside-min.png') }}"
                                alt="First PREMIER Bank">
                            <h2>Protecting Your Interests</h2>
                            <p>First PREMIER Bank is committed to keeping your information secure, whether you are
                                <br />banking in person, online, by phone or paying by check or debit card.</p>
                        ...
                        <div class="container">
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar"><img
                                        src="{{ asset('assets/frontend/globalassets/images/secondary-icons/green/business-finance/green-business-_-finance-secondary-icon-35.png') }}"
                                        title="Tips for Avoiding Fraud" alt="safe" height="116px" width="116px"></div>
                                <div class="b15avtar_content">
                                    <h3>Tips for Avoiding Fraud</h3>
                                    <p>Lost or stolen checks, ATM or debit cards. Unauthorized ATM or debit card purchases
                                        or withdrawals. Suspicious emails, text messages or phone calls are the most
                                        frequent types of fraud reported.</p>
                                    <div class="clearfix"></div><br /> <a
                                        href="tips-for-avoiding-fraud/index.html">Learn More</a>
                                </div>
                            </div>
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar"><img
                                        src="{{ asset('assets/frontend/globalassets/images/secondary-icons/green/phone/green-phone-secondary-icon-12.png') }}"
                                        title="Report Suspicious Activity" alt="phone" height="116px" width="116px"></div>
                                <div class="b15avtar_content">
                                    <h3>Report Suspicious Activity</h3>
                                    <p>If you notice suspicious activity on your First PREMIER Bank account, or are
                                        contacted in a manner that seems suspicious, please call Customer Care immediately
                                        at (800) 501-6535.&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</p>
                                    <div class="clearfix"></div><br /> <a
                                        href="reporting-suspicious-activity-or-fraud/index.html">Learn More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{ asset('assets/frontend/contentassets/e83ff75039ec4e7d9d19fa9b67a9509e/1.1.5_b-16-list-01-alternating-1-mombaby-min.png') }}"
                                                title="Ways We Protect You" alt="mother talking to child"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>Ways We Protect You</h2>

                                        <div class="xhtml">
                                            <p>First PREMIER Bank takes proactive security measures to help reduce the risk
                                                of fraud-related activity on your accounts:&nbsp;<br /><br /></p>
                                            <ul>
                                                ...
                                                <li>Multi-factor authentication helps validate identity at sign-in&nbsp;
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="{{ asset('assets/frontend/contentassets/a2b33aa2726444969fb614afdd547c24/1.1.5_b-16-list-01-alternating-2-phonewoman-min.png') }}"
                                                title="Protecting Yourself" alt="woman on mobile phone"></div>

                                    </div>
                                    <div class="b16basic_box_left payIcon-space">
                                        <h2 style="padding-top:0px !important;">Protecting Yourself</h2>
                                        <div class="xhtml">
                                            <p>Incorporating a few practices can help keep your accounts safe.<br /><br />
                                            </p>
                                            <ul>
                                                <li>Sign up for free <a title="Online and Mobile Banking"
                                                        href="../../online-and-mobile/index.html" target="_top">Online and
                                                        Mobile Banking</a> and <a title="Bill Pay"
                                                        href="../../online-and-mobile/bill-pay/index.html"
                                                        target="_top">Bill Pay</a></li>
                                                <li>Reduce the likelihood of mail fraud with <a title="eStatements"
                                                        href="../../online-and-mobile/estatements/index.html"
                                                        target="_top">eStatements</a></li>
                    ...
                    <div class="b18great_feature_main">
                        ...
                        <div class="b18great_feature_left">
                            ...
                            <div class="b18detail xhtml">
                                <p>It&rsquo;s important to take financial care of our older loved ones. Learn what it means
                                    to be a financial caregiver with our interactive module.</p>
                            </div>
                        ...
                        <div class="b18great_feature_left b18great_feature_right payIcon-space">
                            ...
                            <div class="b18detail xhtml">
                                <ul>
                                    <li><a title="Tips for Avoiding Fraud" href="tips-for-avoiding-fraud/index.html">Tips
                                            for Avoiding Fraud</a></li>
                                    <li><a title="Reporting Fraud"
                                            href="reporting-suspicious-activity-or-fraud/index.html">Reporting Fraud</a>
                                    </li>
                                    <li><a title="Responding to Identity Theft"
                                            href="responding-to-id-theft-and-fraud/index.html">Responding to Fraud &amp;
                                            Identity Theft</a></li>
                                </ul>
                            </div>
                        </div>
                                                    ...
                                                    <div class="col-md-12" style="padding-left:40px;">
                                                        ...
                                                        <div class="b46Blue" style="text-align:left;">
                                                            <p>Please note, by clicking &ldquo;continue&rdquo; you will be
                                                                ...
                                                                links, privacy policy or security of that website.&nbsp;
                                                                Your use of that website is subject to its terms of use and
                                                                privacy policy.&nbsp; Thank you for visiting
                                                                firstpremier.com.&nbsp; If you continue, we hope you find
                                                                the information presented educational and useful.</p>
                                                            <p><br /><a
                                                                    href="https://firstpremier.everfi-next.net/student/dashboard/financialeducation-achieve/firstpremier-preventing-elder-fraud"
                                                    ...
                                                    <div class='b26line_credit_loans_right'>
                                                        ...
                                                        <h3><br clear='all' />
                                                            <div class="xhtml">
                                                                ...
                                                                <ul>
                                                                    <li><a href="../free-plus-checking/index.html">FREE+
                                                                            Checking</a></li>
                                                                    <li><a href="../reward-checking/index.html">Reward
                                                                            Checking</a></li>

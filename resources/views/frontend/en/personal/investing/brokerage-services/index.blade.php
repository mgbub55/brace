        ...
        <section class="row-full">
            <div class="b46productpage">
                <div class="container">
                    ...
                    <img src="{{ asset('assets/frontend/contentassets/41a41a811eef41f5a46d81bb71c69092/1.6.1_b-46_couplebroker-min.png') }}"
                        alt="First PREMIER Bank">
                    <h2>Investing Made Easy</h2>
                    <p>A simple, easy and smart way to invest for the future, combining professional advice with turnkey
                        online access.</p>

                    <a href="https://myaccount.iconnect2invest.com/bankr/login.do?webcontext=iconnect"
                        class="b46button">LOG INTO YOUR ACCOUNT</a>
                        ...
                        <div class="b16basic_box b16basic_box_position">
                            <div class="b16basic_box_right" style="padding-right:50px;">
                                <div class="b16imgcrop"><img
                                        src="{{ asset('assets/frontend/contentassets/35b26bf9add8478fa2e5f9f40f7b1451/1.6.1_b-16-list01_alternating-1_family-min.png') }}"
                                        title="Investing for Everyone" alt="couple looking over bank statements"></div>
                            </div>
                        ...
                        <div class="b16basic_box">
                            <div class="b16basic_box_right">
                                <div class="b16imgcrop" style="margin-left:90px;"><img
                                        src="{{ asset('assets/frontend/contentassets/f096e2076dc943a7bf5aacf93bf2a388/1.6.1_b-16-list01_alternating-2_lady-min.png') }}"
                                        title="Easy Access" alt="woman filling out form"></div>
                ...
                <div class="b16basic_box_main">
                    <div class="container">
                        <div class="b16basic_box b16basic_box_position">
                            <div class="b16basic_box_right" style="padding-right:50px;">
                                <div class="b16imgcrop"><img
                                        src="{{ asset('assets/frontend/contentassets/ea280d575a2846fc8c24857a7ace1817/1.6.1_b-16-list01_alternating-3_retire-min.png') }}"
                                        title="Retirement Planning" alt="retired couple riding bikes"></div>
                            </div>
                            <div class="b16basic_box_left">
                                <h2>Retirement Planning</h2>

                                <div class="xhtml">
                                    <p>Let First PREMIER professionals help you select from an array of retirement
                                        investment options. From choosing the right plan to support your retirement
                                        strategy, to helping you with consolidation or rollover, our seasoned investment
                                        team can help make your retirement goals a reality.</p>
                                </div>
                                <!-- Button and Footer Links go here ... -->
                                ...
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">
                                        <img class="close_icon"
                                            ...
                                            alt="First PREMIER Bank" style="height:17px !important;width:17px !important;">
                                    </span>
                                </button>
    ...
    <div class="block b04block  col-md-12">
        <style>
            @media screen and (min-width: 767px) {
                .b18great_feature_main .b18great_feature_left .b18detail:nth-child(1) {
                    padding-left: 125px;
                }

                .b18great_feature_left .b18deatil ul {
                    padding-left: 130px;
                }
        ...
        <section class="row-full">
            <div class="b13what_you_know_main">
                <div class="container" style="background-color:#182e39 !important;">
                    ...
                    <h4> Disclosure </h4>
                    <div class="b13points">
                        <p>{1} Securities and insurance products are offered through Cetera Investment Services LLC (doing
                            insurance business in CA as CFGIS Insurance Agency), member <a href="http://www.sipc.org/"
                                target="_blank" rel="noopener">FINRA/SIPC</a>. Advisory services are offered through Cetera
                            Investment Advisers LLC. Neither firm is affiliated with the financial institution where
                            investment services are offered. Investments are:</p>
                        <ul>
                        ...
                        <p><br />Check the background of our investment professionals on FINRA&rsquo;s <a
                                href="http://brokercheck.finra.org/" target="_blank" rel="noopener">BrokerCheck</a></p>
                        ...
                        <p>This site is published for residents of the United States only. Registered Representatives of
                            Cetera Investment Services LLC may only conduct business with residents of the states and/or
                            jurisdictions in which they are properly registered. Not all of the products and services
                            referenced on this site may be available in every state and through every advisor listed. For
                            additional information please contact the advisor(s) listed on the site or visit the Cetera
                            Investment Services LLC site at <a href="http://www.ceterainvestmentservices.com/"
                                target="_blank" rel="noopener">www.ceterainvestmentservices.com</a>.</p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="xhtml">
                        <div class="row-full footer" style="background-color: #17554a !important;">
                            <div class="container">
                                <div class="col-md-12">
                                    <div class="col-md-6">
                                        <h3 style="text-transform: uppercase; color: #fff; font-weight: bold;">INFORMATION
                                        </h3>
                                        <p>&nbsp;</p>
                                        <p><u>First PREMIER Bank</u><br />Investment Services (605) 978-9725</p>
                                        <p>&nbsp;</p>
                                        <p>Cetera registered branch:<br />601 S. Minnesota Avenue<br />Sioux Falls, SD 57104
                                        </p>
                                    </div>
                                    <div class="col-md-6">
                                        <h3 style="text-transform: uppercase; color: #fff; font-weight: bold;">LEGAL NOTICES
                                        </h3>
                                        <p>&nbsp;</p>

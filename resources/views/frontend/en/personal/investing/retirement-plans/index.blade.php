                                ...
                                <div class="panel-heading b60Menu">
                                    ...
                                    <div class="ceteramenu" style="border-top:#c8c8c8 1px solid;">
                                        <a class="ceteralink" href="../index.html"
                                            ...
                                            class="ceteralink" href="../financial-and-investing-resources/index.html"
                                ...
                                <article>
                                    <div class="col-sm-12 SubMenuItems">
                                        <ul id="ulPremierMainMenu">
                                            ...
                                            <li class="SubMenu"><a class="ceteralink"
                                                    href="../financial-and-investing-resources/index.html"
                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="{{ asset('assets/frontend/contentassets/75e89f15f5464f37b0a7e877050bceff/1.6.2_b-46-hero_couple-min.png') }}"
                            ...
                            <p style="text-align: center;">It's never too early - or too late - to develop a plan that will
                                carry you to a comfortable retirement! <br />First PREMIER can help you navigate the road
                                ahead to meet your financial goals.</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{ asset('assets/frontend/contentassets/9db19a688fc64c648212b96f322999a8/1.6.2_b-16-list01_alternating-2_planning-min.png') }}"
                                    ...
                                    <div class="b16basic_box_left">
                                        ...
                                        <div class="xhtml">
                                            <p>We can assist with 401(k) rollovers, Individual Retirement Accounts (IRAs)
                                                and more. An IRA is a tax-efficient way for you to save, and allows your
                                                money to grow tax free while it's in the account. The type of IRA you choose
                                                will depend on your age, income and financial goals. You can&nbsp;<a

...
<section class="row-full">
    <div class="b46productpage">
        <div class="container">
            <h1>Bill Pay</h1>
                <img src="{{asset('assets/frontend/contentassets/7e9ed62b7601449f9a65eaa236786d85/1.2.3_b-46-subpage-hero-01-benefits_couplebills-min.png')}}" alt="First PREMIER Bank">
                            <h2>Free Yourself from Stamps, Envelopes &amp; Paper Checks </h2>
            <p>This FREE feature of Online and Mobile Banking lets you schedule payments quickly and easily, managing bill payment from one place.</p>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/19d4dfb3cf93448fb72d255d6a70daad/1.2.3_b-16-list-01-alternating-1_womanphone-min.png')}}" title="FREE Features" alt="woman looking at mobile phone"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>FREE Features</h2>

                                <div class="xhtml"><ul>
<li>Secure access through <a title="Online &amp; Mobile Banking" href="../index.html" target="_top">Online &amp; Mobile Banking</a></li>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/dcc0ded0a28442ada8bb7ece6b2ec36c/1.2.3_b-16-list-01-alternating-2_guybills-min-left.png')}}" title="Bill Pay Benefits" alt="man working at desk with papers and computer"></div>
...
<li><a href="../../../pages/resources/sanford-health/first-premier-bank-sanford-partnership-offers/index.html">Giving Back to Community</a></li>
                ...
                <div class="b26Mobile col-sm-6 hidden-md hidden-lg" style="left:-8px;">
                    ...
                    <div class="b26MobileCard" style="width:345px;min-height:700px;">
                        <div class='item'><div class='col-xs-12 col-sm-12 b26AltClass b26line_credit_loans b26line_personal_loans no-pad '><div><img src='{{('assets/frontend/globalassets/ymabii/personal/b-17-promo-01-loans-credit.png')}}' alt='couple shaking hands with banker'></div><div class='b26line_credit_loans_right'><div class="b26titlerow"><h3 class='deckspanNoCaret'>Loans & Credit Lines</h3></div><h3><br clear='all'/><div class="xhtml"><p>Competitive rates on loans of all sizes, lines of credit and more. We make our lending decisions locally.</p>
<ul>
<li><a href="../../loans-and-credit-lines/personal-loans/index.html">Personal Loans</a></li>
<li><a href="../../loans-and-credit-lines/personal-lines-of-credit/index.html">Personal Lines of Credit</a></li>

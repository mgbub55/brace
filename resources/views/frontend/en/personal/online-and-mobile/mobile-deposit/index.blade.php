...
<section class="row-full">
    <div class="b46productpage">
        <div class="container">
            <h1>FREE Mobile Deposit</h1>
                <img src="{{asset('assets/frontend/contentassets/55e06a7ca1954ce6bbaeb2c380f30623/1.2.8_b-46-subpage-hero-01-benefits_womandeposit-min.png')}}" alt="First PREMIER Bank">
                            <h2>Snap a photo of any check to make a deposit</h2>
            <p>With Mobile Deposit, a feature of Mobile Banking, simply take a picture of your check with your phone or tablet and deposit your check directly into your First PREMIER Bank account.</p>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/e700a84ec9a44672a5163ed8cb8cc3cc/1.2.8_b-16-list-01-alternating-1_couplephone-min.png')}}" title="FREE with Mobile Banking" alt="couple using mobile phone"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>FREE with Mobile Banking</h2>

                                <div class="xhtml"><ul>
<li>Deposit checks on-the-go with our Mobile Banking app</li>
<li>No need to worry about making it to the bank</li>
<li>Follow instructions to snap a photo of front/back of check&nbsp;</li>
<li>Tap to deposit into your First PREMIER Checking or Savings&nbsp;</li>
<li>Receive confirmation when your deposit is made</li>
<li>View Mobile Deposit history in Online/Mobile Banking</li>
</ul></div>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/c6399cb07f16498bb1fe9b4c362d8fa9/1.2.8_b-16-list-01-alternating-2_womanphonedeposit-min.png')}}" title="The Details" alt="woman depositing check with mobile phone"></div>
...
<li>Funds deposited by 6 p.m. CST will be available next business day<sup>1</sup></li>
...
<li>Search for and download the FREE First PREMIER Bank app from your phone&rsquo;s app store, <a href="https://itunes.apple.com/us/app/first-premier-bank-south-dakota/id727332747?mt=8">Apple App Store</a> or <a href="https://play.google.com/store/apps/details?id=com.firstpremierbank3390.mobile">Google Play</a>.</li>
<li>Open the application</li>
<li>Click the option for &ldquo;New Online Customer Enrollment&rdquo;</li>
<li>Complete the quick enrollment form&nbsp;</li>
<li>Begin using Mobile Banking</li>
<li>View detailed Mobile Banking demonstrations below</li>
</ul></div>
                                </div>
        <div class="b18great_feature_left b18great_feature_right payIcon-space">
                <span>Make a Mobile Deposit</span>
                            <div class="b18detail xhtml"><ul>
<li>Open your First PREMIER Bank Mobile Banking app</li>
<li>Press &ldquo;Deposit Check&rdquo; from the left-side menu</li>
<li>Choose the eligible account into which you&rsquo;d like to deposit the check</li>
<li>Enter the check amount</li>
<li>Take a picture of the front and back of the check</li>
<li>Press &ldquo;Submit Deposit&rdquo;</li>
</ul></div>
                                </div>
        <div class="clearfix">
            <center>
    ...
    <div id="a601188" class="modal fade" role="dialog">
    ...
    <div id="b601188" class="modal fade" role="dialog">
        <div class="modal-dialog pop_board">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="pop_main_container_board">
    ...
    <div id="c601188" class="modal fade" role="dialog">
        <div class="modal-dialog pop_board">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="pop_main_container_board">
...
<script type="text/javascript">
    ...
    <div class="smallLogo"><a href="../../../index.html" title="First PREMIER Bank - Home"><img src="{{asset('assets/frontendStatic/gfx/Logo.png')}}" style="max-width:100%;" /></a></div>

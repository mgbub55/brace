...
<style>
    ...
    .b46productpage { float:left; width:100%; padding:80px 0px 50px 0px; text-align:center; background:#fff url("{{('assets/frontend/globalassets/images/backgrounds/grey-2.svg')}}") no-repeat;}
</style>
<section class="row-full">
    <div class="b46productpage">
        <div class="container">
            <h1>Financial Management Tools</h1>
                <img src="{{asset('assets/frontend/contentassets/141c09fb04194647a5bdbf789cb4d250/1.2.6_b-46-subpage-hero-01-benefits_handbills-min.png')}}" alt="First PREMIER Bank">
                            <h2>Analyze Spending &amp; More</h2>
            <p>Our online and mobile financial management tools can help you create a private, secure comprehensive financial snapshot, assess your spending patterns, plan a budget and more.</p>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/aad4368b139843e69c2bb85b22c208be/1.2.6-b-16-list-01-alternating-1-couplelaptop-min-right.png')}}" title="Yours FREE" alt="couple looking at laptop"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>Yours FREE</h2>

                                <div class="xhtml"><ul>
<li>View First PREMIER Bank accounts</li>
<li>Link external accounts for a broader picture</li>
<li>Get a consolidated view of spending and debt</li>
<li>Calculate your net worth and debt-to-income ratio</li>
<li>Craft a budget based on real financial data and trends</li>
</ul></div>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/806375d24ca84c8b947e87160a2ac9f1/1.2.6_b-16-list_01_alternating-2_screenshot-min.png')}}" title="Actionable &amp; Helpful" alt="person using laptop"></div>

                        </div>
                        <div class="b16basic_box_left payIcon-space">
                            <h2 style="padding-top:0px !important;">Actionable &amp; Helpful</h2>
                                <div class="xhtml"><ul>
<li>Get a centralized view of your financial life</li>
<li>Organize spending into customizable categories&nbsp;</li>
<li>View meaningful visual charts, graphs and analysis</li>
<li>Identify spending trends and opportunities</li>
<li>Establish a budget to reach your financial goals</li>
</ul></div>
        ...
        <div class="b16basic_box_left_content b16basic_box_background">
            <div class="b16basic_box_main">
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/27307355fa3c42f58c18321b7c5a521f/1.2.6_b-16-list-01-alternating-3_mother-min.png')}}" title="Getting Started is Easy" alt="woman with baby in lap using laptop"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>Getting Started is Easy</h2>

                                <div class="xhtml"><ul>
<li>Enroll in <a href="../index.html">Online or Mobile Banking</a></li>
<li>Log in to your account</li>
<li>Tools list along the top of the screen to the left of the &ldquo;Link Account&rdquo; option</li>
</ul></div>
                            <!-- Button and Footer Links go here ... -->
                            <!-- Button and Footer Links go here ... -->
                        </div>
            ...
            <div class="b12container">
                ...
                <div class="tabbable">
                    <div class="tab-content col-md-7">
                        <div class="tab-pane active" id="A"><span>What types of accounts can I add to my Financial Management Tool?</span><p><p>You can link checking and savings accounts, investments, credit cards, loans, or other lines of credit from almost any financial institution. These accounts will automatically update every time you visit the feature in Online Banking.</p></p></div><div class="tab-pane" id="B"><span>How can I monitor my spending with my Financial Management Tool?</span><p><p>The color-coded spending wheel makes it easy for you to quickly identify your biggest expenses, as well as dive into the smallest details. Select a piece of the wheel to see how much you spent in each category.</p></p></div><div class="tab-pane" id="C"><span>How can I create a budget?</span><p><p>Add your accounts from other institutions to your Financial Management Tool and choose the option to auto generate a budget, based on your past spending. The more complete your spending history, the more accurate and helpful your initial budget will be. Big bubbles represent a larger portion of your monthly budget, and red bubbles have exceeded their monthly allowance. Budgets will calculate your average monthly spending in each category.</p></p></div><div class="tab-pane" id="D"><span>Is there a fee to use my Financial Management Tool?</span><p><p>There are no fees associated with utilizing the Financial Management Tool.</p></p></div><div class="tab-pane" id="E"><span>How can I access my Financial Management Tool?</span><p><p>You must be enrolled in Online Banking or Mobile Banking to access the Financial Tools. When you access your account online, you can link your accounts in the Navigation bar at the top. When accessing your account on the mobile app, Financial Tools can be found in the menu bar along the bottom.</p></p></div>
                    </div>
                    <ul class="nav nav-pills nav-stacked col-md-5">
                        <li class="active"><a href="#A" data-toggle="tab">What types of accounts can I add to my Financial Management Tool?</a></li><li><a href="#B" data-toggle="tab">How can I monitor my spending with my Financial Management Tool?</a></li><li><a href="#C" data-toggle="tab">How can I create a budget?</a></li><li><a href="#D" data-toggle="tab">Is there a fee to use my Financial Management Tool?</a></li><li><a href="#E" data-toggle="tab">How can I access my Financial Management Tool?</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="row-full b4background">
    <div class="container">
        <div class="b4anywhere_banking" style="width:100%; ">
                                <h2 style="text-align:center !important;">Personal Finance Manager</h2>
                            <div class="xhtml"><div class="videoWrapper"><center><iframe src="http://player.vimeo.com/video/428604356?title=0&amp;amp;byline=0" frameborder="0" allowfullscreen="allowfullscreen"></iframe>

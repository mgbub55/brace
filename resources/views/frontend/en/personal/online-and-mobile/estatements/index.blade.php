...
<section class="row-full">
    <div class="b46productpage">
        <div class="container">
            <h1>eStatements</h1>
                <img src="{{asset('assets/frontend/contentassets/b841ff6444c643508af711218457ffd8/1.2.2_b-46-subpage-hero-01-benefits_couplecomp.png')}}" alt="First PREMIER Bank">
                            <h2>Go Paperless with Electronic Statements</h2>
            <p style="text-align: center;">A feature of Online and Mobile Banking, eStatements are a fast and efficient way to track account history. They also help reduce mail fraud and are better for the environment.</p>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/6a4e108a53294cd6a9eed1baee752974/1.2.2_b-16-list-01-alternating-1_couplebill-min1.png')}}" title="Features" alt="couple looking at laptop"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>Features</h2>

                                <div class="xhtml"><ul>
<li>Automatic enrollment with <a href="../online-banking/index.html">Online Banking</a>&nbsp;or <a href="../mobile-banking/index.html">Mobile Banking</a></li>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/27e7fc5d775d495e841e07d1542253c6/1.2.2_b-16-list-01-alternating-2_comp-min1.png')}}" title="Benefits" alt="man looking at computer monitor"></div>
...
<li>Convenient access within <a title="online and mobile banking" href="../index.html">Online and Mobile Banking</a></li>
            ...
            <div class="b12container">
                ...
                <div class="tabbable">
                    <div class="tab-content col-md-7">
                        <div class="tab-pane active" id="A"><span>What are eStatements?</span><p><p>eStatements are copies of your paper statement viewed through Online or Mobile Banking. They may be viewed in a PDF file so you can access, save or print them at any time.</p></p></div><div class="tab-pane" id="B"><span>How do I start using eStatements?</span><p><p>Simply click on the Settings menu within Online Banking and then choose the Statement Delivery tab. Change your delivery type from Paper Statements to eStatements. An email will be sent within two business days to confirm your enrollment. When your statement is available to be viewed, an email will be sent with instructions on how to access the information.</p></p></div><div class="tab-pane" id="C"><span>Which accounts will I be able to view in eStatements?</span><p><p>eStatements are available for checking or savings accounts. If a savings account is on a combined statement, you will need to enroll your checking account in order to view both.</p></p></div><div class="tab-pane" id="D"><span>How long will I be able to access my eStatements?</span><p><p>You will be able to access up to 24 months of statements from the time you sign up. However, you can save your statement to your computer as a PDF to access anytime.</p></p></div>
                    </div>
                    <ul class="nav nav-pills nav-stacked col-md-5">
                        <li class="active"><a href="#A" data-toggle="tab">What are eStatements?</a></li><li><a href="#B" data-toggle="tab">How do I start using eStatements?</a></li><li><a href="#C" data-toggle="tab">Which accounts will I be able to view in eStatements?</a></li><li><a href="#D" data-toggle="tab">How long will I be able to access my eStatements?</a></li>
                    </ul>
                </div>
            </div>
        </div>

    ...
    <div class="b46productpage">
        <div class="container">
            <h1>FREE Mobile Banking</h1>
                <img src="{{asset('assets/frontend/contentassets/8bcb62ae949943b3ad4f225474f3e4ea/1.2.7_b-46-subpage-hero-01-benefits_womanphone-min.png')}}" alt="First PREMIER Bank">
                            <h2>All the Benefits of Online Banking and More</h2>
            <p>Enjoy convenient access from any mobile device, FREE!&nbsp; Check account balances, make transfers, pay bills, locate ATMs, deposit checks, receive electronic bank statements and more.</p>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/a4201f0e94a246cb8f6f4f757c90436f/1.2.4_b-16-list-01-alternating-1_womanpay-min-right.png')}}" title="The Basics" alt="woman paying at counter with mobile phone"></div>
                        </div>
...
<li>Use <a href="../mobile-deposit/index.html">Mobile Deposit</a> to deposit checks&nbsp;</li>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/169e5547a4454d1fb23cc049e09eac45/new-mobile-wallet-image.png')}}" title="More Benefits" alt="Mobile Debit Card"></div>
...
<li>Use free <a href="../personal-financial-management/index.html">spending analysis and budgeting tools</a></li>
<li>Schedule and make payments with <a href="../bill-pay/index.html">Online Bill Pay</a></li>
<li>Easily lock and unlock lost or stolen debit cards</li>
<li>View up-to-36 months of transaction history</li>
<li>Receive paperless monthly <a href="../estatements/index.html">eStatements</a></li>
</ul></div>
            ...
            <div class="b12container">
                ...
                <div class="tabbable">
                    <div class="tab-content col-md-7">
                        <div class="tab-pane active" id="A"><span>Is there a fee for Mobile Banking?</span><p><p>Mobile Banking is a free service for our personal and business banking customers.</p></p></div><div class="tab-pane" id="B"><span>Do I need to enroll for Online Banking before enrolling in Mobile Banking?</span><p><p>No, you can download our Mobile Banking App from one of the App Stores and enroll directly by choosing the "For New Online Customer Enrollment Only" link.</p></p></div><div class="tab-pane" id="C"><span>What types of checks can I deposit using Mobile Banking?</span><p><p>You can deposit checks payable in U.S. dollars and drawn on any U.S. bank, including personal, business and government checks. They must also be payable to and endorsed by the account holder and with "For Mobile Deposit Only. First PREMIER Bank."&nbsp;<br />International checks, U.S. savings bonds, U.S. postal money orders, remotely created checks (whether in paper form or electronically created), convenience checks (checks drawn against a line of credit) and cash are not eligible for Mobile Deposit.</p></p></div>
                    </div>
                    <ul class="nav nav-pills nav-stacked col-md-5">
                        <li class="active"><a href="#A" data-toggle="tab">Is there a fee for Mobile Banking?</a></li><li><a href="#B" data-toggle="tab">Do I need to enroll for Online Banking before enrolling in Mobile Banking?</a></li><li><a href="#C" data-toggle="tab">What types of checks can I deposit using Mobile Banking?</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="b16basic_box_left_content b16basic_box_background">
            <div class="b16basic_box_main">
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/0c2e8370109e4998a5721f8319fa9bc7/1.2.4_b-16-list-01-alternating-3_womanphone-min.png')}}" title="Mobile Wallet" alt="woman looking at mobile phone"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>Mobile Wallet</h2>

                                <div class="xhtml"><p>Make secure, simple and convenient payments by adding your First PREMIER Bank Debit Mastercard&reg; to the following mobile wallets:<br /><br /></p>
<ul>
<li><a title="Apple Pay" href="../mobile-wallet/apple-pay/index.html">Apple Pay</a>&reg;</li>
...
<li>View detailed Mobile Banking demonstrations below<br /><br /><a href="https://itunes.apple.com/us/app/first-premier-bank-south-dakota/id727332747?mt=8"><img src="{{asset('assets/frontend/globalassets/images/store_apple-min.png')}}" alt="store_apple-min.png" width="192" height="57" /></a>&nbsp; &nbsp;<a href="https://play.google.com/store/apps/details?id=com.firstpremierbank3390.mobile"><img src="{{asset('assets/frontend/globalassets/images/store_google-min.png')}}" alt="store_google-min.png" width="194" height="58" /></a></li>
</ul></div>
                                </div>
        <div class="b18great_feature_left b18great_feature_right payIcon-space">
                <span>Don&#39;t have a smartphone?</span>
                            <div class="b18detail xhtml"><p>If you don&rsquo;t have a smartphone, you can call Bank by Phone at 800-315-6360, use Online Banking or enroll in Text Banking online. Text Banking lets you use basic commands to receive secure, real-time account balances, view recent transactions and find ATM and branch locations. To enable Text Banking simply:</p>
<ul>

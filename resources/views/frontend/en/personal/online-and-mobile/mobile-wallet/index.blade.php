        ...
        <div class="row equal-height">
            <div class="block b46block  col-md-12">
                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            <h1>Mobile Wallet</h1>
                            <img src="{{asset('assets/frontend/contentassets/516175e73a6e425a859cf779c8c8de39/1.2.4_b-46-subpage-hero-01-benefits_womengrouppay-min.png')}}"
                                alt="First PREMIER Bank">
                            <h2>Speed Your Way Through Checkout</h2>
                            <p>Leave your traditional bulky wallet at home. Use your phone or other mobile device to pay
                                faster and easier at checkout.&nbsp;</p>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="{{asset('assets/frontend/contentassets/cb0c9fee91e646eab6bcdf8825bc7346/1.2.4_b-16-list-01-alternating-1_womanpay-min.png')}}"
                                                title="Mobile Wallet Basics" alt="woman paying bill with mobile phone">
                                        </div>

                                    </div>
                                    <div class="b16basic_box_left payIcon-space">
                                        <h2 style="padding-top:0px !important;">Mobile Wallet Basics</h2>
                                        <div class="xhtml">
                                            <p>Simply add your First PREMIER Bank Debit Mastercard&reg; to the mobile
                                                wallet of your choosing. Pay with a simple tap of your smartphone,
                                                smartwatch or tablet at checkout. It&rsquo;s a fast, secure and
                                                contactless way to pay.&nbsp;</p>
                                        </div>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{asset('assets/frontend/contentassets/130d3619e0544d43914bc52daca68b92/fpb_mobile_wallet.png')}}"
                                                title="How it Works" alt="Man paying bill with mobile phone"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        ...
                                        <div class="xhtml">
                                            <ul>
                                                <li>Simply download and/or open your mobile wallet</li>
                                                <li>Load your debit card number</li>
                                                <li>Add pin or other security measures as instructed</li>
                        ...
                        <div class="b16basic_box_main b16basic_box_grey">
                            <div class="container">
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="{{asset('assets/frontend/contentassets/c135db9f1c744212b35673650b4b230c/1.2.4_b-16-list-01-alternating-3_womanphone-min-left.png')}}"
                                                title="Secure &amp; Streamlined" alt="woman looking at mobile phone">
                                        </div>

                                    </div>
                                    <div class="b16basic_box_left payIcon-space">
                                        <h2 style="padding-top:0px !important;">Secure &amp; Streamlined</h2>
                                        <div class="xhtml">
                                            <ul>
                                                <li>Speed your way through checkout</li>
                                                <li>Disable mobile wallet online if your device is lost or stolen&nbsp;
                                                </li>
                                                <li>Receive Zero Liability&reg; Protection coverage for all First
                                                    PREMIER Bank Debit Mastercard&reg; purchases</li>
            ...
            <div class="block b18block  col-md-12">
                ...
                <section>
                    <div class="b18great_feature_main">
                        ...
                        <div class="b18great_feature_left">
                            ...
                            <div class="b18detail xhtml">
                                <p>Select the mobile wallet app that works best for you.<br /><br /></p>
                                <ul>
                                    <li>One may already be installed on your phone</li>
                                    <li>Others are available for download in your app store</li>
                                    <li>Do some research to select a wallet with features you like best</li>
                                    <li>Check to see which wallets the merchants near you accept</li>
                                </ul>
                            </div>
                        </div>
                        <div class="b18great_feature_left b18great_feature_right payIcon-space">
                            ...
                            <div class="b18detail xhtml">
                                <p>First PREMIER supports the following mobile wallet applications:</p>
                                <ul>
                                    <li><a href="apple-pay/index.html">Apple Pay</a></li>
                                    <li><a href="google-pay/index.html">Google Pay</a></li>
                                    <li><a href="samsung-pay/index.html">Samsung Pay</a></li>
                                </ul>
                            </div>
                            <a href="https://www.apple.com/apple-pay/"><img
                                    src="{{asset('assets/frontend/Static/img/PayIcons/apple-pay-icon.png')}}" border="0" /></a><a
                                href="https://pay.google.com/about/"><img
                                    src="{{asset('assets/frontend/Static/img/PayIcons/android-pay-icon.png')}}" border="0"
                                    class="payIcon" /></a><a href="https://www.samsung.com/us/samsung-pay/"><img
                                    src="{{asset('assets/frontend/Static/img/PayIcons/samsung-pay-icon.png')}}" border="0"
                                    class="payIcon" /></a> <br />
                        </div>
                        <div class="clearfix">
                            <center>
                    ...
                    <div id="a21284618" class="modal fade" role="dialog">
                    ...
                    <div id="b21284618" class="modal fade" role="dialog">
                        <div class="modal-dialog pop_board">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="pop_main_container_board">
                    ...
                    <div id="c21284618" class="modal fade" role="dialog">
                        <div class="modal-dialog pop_board">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="pop_main_container_board">
                    ...
                    <div class="b12container">
                        ...
                        <div class="tabbable">
                            <div class="tab-content col-md-7">
                                <div class="tab-pane active" id="A"><span>How do I get the Mobile Wallet app?</span>
                                    <p>
                                    <p>You can download the mobile wallet from your respective App Store and follow the
                                        instructions on how to add your First PREMIER Bank Debit Mastercard.</p>
                                    </p>
                                </div>
                                <div class="tab-pane" id="B"><span>What Mobile Wallets work with my First PREMIER Bank
                                        Debit Mastercard?</span>
                                    <p>
                                    <p>You can use your First PREMIER Bank Debit Mastercard with Apple Pay, Google Pay,
                                        and Samsung Pay.</p>
                                    </p>
                                </div>
                                <div class="tab-pane" id="C"><span>What is Mobile Wallet?</span>
                                    <p>
                                    <p>A Mobile Wallet is digital form of your First PREMIER Bank debit card information
                                        on your mobile device. You can pay for purchases without using your physical
                                        plastic debit card.</p>
                                    </p>
                                </div>
                            </div>
                            <ul class="nav nav-pills nav-stacked col-md-5">
                                <li class="active"><a href="#A" data-toggle="tab">How do I get the Mobile Wallet
                                        app?</a></li>
                                <li><a href="#B" data-toggle="tab">What Mobile Wallets work with my First PREMIER Bank
                                        Debit Mastercard?</a></li>
                                <li><a href="#C" data-toggle="tab">What is Mobile Wallet?</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <section class="row-full">
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <h4> Disclosure </h4>
                            <div class="b13points">
                                <p>{1} Mobile Wallet features and functionality vary.&nbsp; For specific information for
                                    your mobile wallet, please consult the individual wallet pages for
                                    instructions.&nbsp;Mobile wallets are similar with regards to the features and
                                    security measures they offer. The right one for you depends on your personal
                                    preference, the device you are using, the type of credit and debit cards you have,
                                    and how you wish to interact with your apps.</p>
                            </div>
                        </div>
                    </div>
                </section>

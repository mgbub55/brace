    ...
    <div class="b46productpage">
        <div class="container">
            <h1>Easy Access Line of Credit</h1>
                <img src="{{asset('assets/frontend/contentassets/96b636babfb44051b73af498896f45d7/1.4.2_b-46-hero_couple-min.png')}}" alt="First PREMIER Bank">
                            <h2>A flexible credit line of up to $5,000</h2>
            <p style="text-align: center;">This basic, revolving line of credit gives you extra purchasing power and cash when you need it.&nbsp; <br />It&rsquo;s perfect for overdraft protection<sup>1</sup> and comes with flexible payment options.</p>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/4446fd986f8d4ece9ae55db9a0ca0b59/1.1.3_b-16-list-01-alternating-1_ladykeeper-min-right.png')}}" title="Everyday Cash Access" alt="woman cashier accepting credit card for payment"></div>
                        </div>
...
<li>FREE&nbsp;<a href="../../online-and-mobile/bill-pay/index.html">Bill Pay</a>, <a title="eStatement" href="../../online-and-mobile/estatements/index.html" target="_top">eStatements</a>&nbsp;<a href="../../online-and-mobile/mobile-deposit/index.html">Mobile Deposit</a> and more!&nbsp;</li>
</ul></div>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/3d33eb219c054d488689c323946d8e0e/1.4.2_b-16-list01_alternating-2_handmachine-min.png')}}" title="Account Features" alt="man paying at register with mobile phone"></div>
...
<li>Use as <a href="../../personal-checking/overdraft-protection/index.html">overdraft protection</a><sup>1</sup> for your First PREMIER Checking</li>
        ...
        <div class="container">
            ...
            <div class="b17free_mobile_banking_right">
                    <h3>Personal Loans</h3>
                                <div class="xhtml"><p>First PREMIER Bank makes all its lending decisions locally based on your personal needs, situation and credit score. Let our seasoned pros help you find the right loan to consolidate debt, buy a new or used car, remodel your home or pay for a large purchase or vacation.</p></div>
                ...
                <div class="b17free_mobile_banking_left right">
                    <img class="img-responsive" id="imgMainImage" style="border-radius:50%" src="{{asset('assets/frontend/contentassets/2a50a3d4c1da41d68c93d53a6f3db05d/1.4.2_b-17-promo_womancar-min.png')}}" alt="First PREMIER Bank">
                </div>
        </div>
    </div>
        ...
        <div class="b15benfits_main_box b17cards">
            <div class="container">
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                <img src="{{asset('assets/frontend/globalassets/images/secondary-icons/blue/business-finance/blue-business-_-finance-secondary-icon-21.png')}}" title="Advance Access Credit Line" alt="woman driving in car with window down" width="116px" height="116px"></div>
                            ...
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                <img src="{{asset('assets/frontend/globalassets/images/secondary-icons/gold/places/gold-places-secondary-icon-14.png')}}" title="Home Equity Credit Line" alt="woman driving in car with window down" width="116px" height="116px"></div>
                                <div class="b15avtar_content">
                                    <h3>Home Equity Credit Line</h3>
                                    <p>Establish a line of credit based on the equity in your home!&nbsp; A great way to make ongoing improvements or fund other large purchases.</p>
                                    <div class="clearfix"></div><br />
...
<section class="row-full">
    <div class="b6featured_quote_main">
            <img src="{{asset('assets/frontend/Static/img/CustomBlocks/B6/featured_bg_a.png')}}" class="b6featured_bg" alt="First PREMIER Bank">
            <img src="{{asset('assets/frontend/Static/img/CustomBlocks/B6/featured_bg_small_a.png')}}" class="b6featured_bg_small_bg" alt="First PREMIER Bank">
        <div class="b6featured_bg_small carousel" id="b06Carousel" data-ride="carousel">
            <div class="">
                <div class="carousel-inner b06carousel-inner">
                    <div class="item active"><div class="row b6mypadding"><div class="b6featured_quote_img col-lg-5 col-md-5"><img src="{{asset('assets/frontend/contentassets/ac292978877443dbad9d4a3bd0949035/quotes-breannabeebe.png')}}" class="b6featured_img" alt="Breanna Beebe Branch Manager"></div><div class="b6featured_quote col-lg-7 col-md-7"><p class="b6alternate">First PREMIER Bank will help you through each stage of your life. It’s not unusual to help newlyweds purchase their first car, assist them in upgrading to a minivan and even refer them to one of our mortgage bankers as they outgrow their home. Seeing them return tells me I’ve done my job well and it makes me smile. </p><div class="clearfix"></div><span> - Breanna Beebe, Branch Manager</span></div></div></div>

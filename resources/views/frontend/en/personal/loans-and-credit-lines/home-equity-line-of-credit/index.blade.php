                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="{{ asset('assets/frontend/contentassets/57a855ef06f14145960423f28adb6a62/1.4.4_b-46-hero_couchcouple-min.png') }}"
                                alt="First PREMIER Bank">
                            <h2>Put Your Home Equity to Work for You</h2>
                            <p>A Home Equity Line of Credit is a great option when it&rsquo;s time to make home improvements
                                or fund larger purchases.</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{ asset('assets/frontend/contentassets/b8f1102c44c041d9b93977720ea7f6df/1.4.4_b-16-list02_alternating-1_guy-min.png') }}"
                                                title="Home Equity Credit Line" alt="male looking at tablet"></div>
                                    </div>
                                        ...
                                        <div class="xhtml">
                                            <ul>
                                                ...
                                                <li>Available for use as <a
                                                        ...
                                                        protection</a><sup>2</sup>&nbsp;for your First PREMIER Bank checking
                                                    account</li>
                                            </ul>
                                        </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="{{ asset('assets/frontend/contentassets/7c65ac43d388484e88f4618b7af4c71a/1.4.4_b-16-list01_alternating-2_home-min1.png') }}"
                                                title="Benefits" alt="couple standing in front of new home"></div>
                    ...
                    <div class="b17free_mobile_banking ">
                        <div class="container">
                            ...
                            <div class="b17free_mobile_banking_right">
                                ...
                                <div class="xhtml">
                                    <p>First PREMIER Bank has competitive rates on loans of all sizes. Use a personal loan
                                        to help fund the purchase of a car, new toy, vacation or larger purchase.
                                        Consolidate debt and pay bills. Our personal loans come with flexible payment plans
                                        and terms that can meet your needs.</p>
                                </div>
                            ...
                            <div class="b17free_mobile_banking_left right">
                                <img class="img-responsive" id="imgMainImage" style="border-radius:50%"
                                    src="{{ asset('assets/frontend/contentassets/93251d2c2b47432998d2729bbe84fff9/1.4.4_b-17-promo_womancar-min.png') }}"
                                    alt="First PREMIER Bank">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="b15benfits_main_box b17cards">
                        <div class="container">
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="{{ asset('assets/frontend/globalassets/images/secondary-icons/blue/business-finance/blue-business-_-finance-secondary-icon-2.png') }}"
                                        title="Advance Access Line of Credit" alt="woman driving car with window down"
                            ...
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="{{ asset('assets/frontend/globalassets/images/secondary-icons/gold/business-finance/gold-business-_-finance-secondary-icon-21.png') }}"
                                        title="Easy Access Credit Line" alt="woman driving car with window down"
                                        width="116px" height="116px">
                                </div>
                                <div class="b15avtar_content">
                                    <h3>Easy Access Credit Line</h3>
                                    <p>Need a smaller line of credit? This basic, revolving line of credit gives you ready
                                        access to the cash you need.</p>
                                    <div class="clearfix"></div><br />
                                    ...
                                    <div class="item active">
                                        <div class="row b6mypadding">
                                            <div class="b6featured_quote_img col-lg-5 col-md-5"><img
                                                    ...
                                                    class="b6featured_img" alt="Mark Henkelman Branch Manager"></div>
                                            <div class="b6featured_quote col-lg-7 col-md-7">
                                                <p>What I love about First PREMIER is that we provide the tools, products
                                                    and services you find at large, national banks. But at the same time, we
                                                    provide the personal touches you expect from a small-town, community
                                                    bank. It’s the PREMIER difference.</p>
                                                <div class="clearfix"></div><span> - Mark Henkelman, Branch
                                                    Manager</span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <div class="b13points">
                                ...
                                <p>{2} When you overdraw your checking account, advances will be made in $300 increments. A

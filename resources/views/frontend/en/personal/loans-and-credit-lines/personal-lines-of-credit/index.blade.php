...
@section('content')
    ...
    <div class="container">
        ...
        <style>
            .b21lines-credit-table td a.regLink {
                color: #268d6e;
            ...
            .b21lines-credit-table td a.btnGreen {
        ...
        <div class="row equal-height">
                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="{{ asset('assets/frontend/contentassets/ca67406b6ace448fa25ce223f9e69fb2/1.4.1_b-46-hero_handshake-min.png') }}"
                                alt="First PREMIER Bank">
                            <h2>Easy Access to Cash When You Need It</h2>
                            <p style="text-align: center;">We offer a number of secured and unsecured personal lines of
                                credit that can help you gain flexible&nbsp;<br />access to cash and serve as optional
                                overdraft protection for your First PREMIER Checking account.</p>
            ...
            <div class="block b21block  col-md-12">
                ...
                <style>
                    ...
                    .b21bottom a.b21mainbutton:hover {
                        background: #182e39;
                    }
                    ...
                    .b21bottom a.b21LinkItem {
                        color: #268d6e;
                        background: url("{{ 'assets/frontend/Static/img/CustomBlocks/B20/arrow_green.png' }}") no-repeat right 3px;
                    ...
                    .b21bottom a.b21LinkItem:hover {
                        color: #1c7258;
                        background: url("{{ 'assets/frontend/Static/img/CustomBlocks/B20/arrow_green_hover.png' }}") no-repeat right 3px;
                        font-size: 14px;
                        font-family: "Prompt-SemiBold";
                        text-shadow: none;
                        text-transform: uppercase;
                    ...
                    .b21bottom ul li a.b21multilink {
                        color: #268d6e;
                        background: url("{{ 'assets/frontend/Static/img/CustomBlocks/B20/arrow_green.png' }}") no-repeat right 3px;
                        padding: 0px 15px 0px 0px;
                        margin-right: 20px;
                    ...
                    .b21bottom ul li a.b21multilink:hover {
                        color: #1c7258;
                        background: url("{{ 'assets/frontend/Static/img/CustomBlocks/B20/arrow_green.png' }}") no-repeat right 3px;
                        padding: 0px 15px 0px 0px;
                        margin-right: 20px;
                ...
                <section>
                    <div class="b21lines-credit-main">
                        <div class="container">
                            ...
                            <div class="detail">
                                <div class="txt">
                                    <p style="text-align: center;">Our flexible lines of credit offer additional buying
                                        power for larger purchases and <br />can help bridge the gap when account balances
                                        go low. Compare options here:</p>
                                </div>
                            </div>
                                ...
                                <table class="b21lines-credit-table">
                                    <tr>
                                        <td style="vertical-align:bottom;">
                                            <h4 class="tab_h4" style="float:right;"></h4>
                                        </td>
                                        <th style="max-width:343px;">
                                            <h3>Easy Access<br />Line of Credit</h3>
                                            <p>An everyday line of credit for flexible access to cash for unexpected
                                                expenses.</p>
                                            <a href="../easy-access-line-of-credit/index.html">Learn More</a>
                                        </th>
                                        <th style="max-width:343px;">
                                            <h3>Advance Access<br />Line of Credit</h3>
                                            <p>For individuals who desire ready access to extra cash for large purchases.
                                            </p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p>Fixed Interest<sup>1</sup></p>
                                        </td>
                                        <td>
                                            <p>Variable Interest<sup>1</sup></p>
                                        </td>
                                        <td>
                                            <p>Variable Interest<sup>1</sup></p>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Secured or unsecured</td>
                                        <td>Secured by your mortgage</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h4>
                                        ...
                                        <td>
                                            <p>FREE Online and Mobile Banking<br />Available as optional <a
                                                    class="regLink"
                                                    href="../../personal-checking/overdraft-protection/index.html">Overdraft
                                                    Protection</a><sup>2</sup></p>
                                        </td>
                                        <td>
                                            <p>FREE Online and Mobile Banking<br />Available as optional <a
                                                    class="regLink"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p><a class="btnGreen"
                                                    href="../easy-access-line-of-credit/index.html">Learn More</a></p>
                                        </td>
                                        <td>
                                            <p><a class="btnGreen"
                                                    href="../advance-access-line-of-credit/index.html">Learn More</a></p>
                                        </td>
                                        <td>
                                            <p><a class="btnGreen"
                                                    href="../home-equity-line-of-credit/index.html">Learn More</a></p>
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        <td>
                                            <table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p><a class="btnGreen"
                                                                href="../easy-access-line-of-credit/index.html">Learn
                                                                More</a></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td>
                                            <table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p><a class="btnGreen"
                                                                href="../advance-access-line-of-credit/index.html">Learn
                                                                More</a></p>
                                                    </td>
                                                </tr>
                                            </table>
                                        ...
                                        <td>
                                            <table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p><a class="btnGreen"
                                                                href="../home-equity-line-of-credit/index.html">Learn
                                                                More</a></p>
                                                    </td>
                                                </tr>
                                            </table>
                ...
                <section class="row-full">
                    ...
                    <div class="b25need_help_main">
                        <div class="container">
                            ...
                            <div class="xhtml">
                                <p style="text-align: center;">Speak to a Personal Banker to discuss your needs.</p>
                            </div>
                    ...
                    <div class="b17free_mobile_banking ">
                        <div class="container">
                            ...
                            <div class="b17free_mobile_banking_right">
                                ...
                                <div class="xhtml">
                                    <p>We have access to an array of loan products and use fast, state-of-the-art loan
                                        processing.&nbsp; Whether you're buying or building a home or refinancing your
                                        existing mortgage, we offer competitive rates on loans of all sizes - with personal
                            ...
                            <div class="b17free_mobile_banking_left right">
                                <img class="img-responsive" id="imgMainImage" style="border-radius:50%"
                                    src="{{ asset('assets/frontend/contentassets/b94c16ca6aca4b229c7ef72d6d03daed/1.4.1_b-17-promo_planning-min-left.png') }}"
                                    alt="First PREMIER Bank">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="b15benfits_main_box b17cards">
                        <div class="container">
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="{{ asset('assets/frontend/contentassets/1e50006b679f4da9881010b847dabf70/everfi-loans-and-payments.png') }}"
                                        title="Loans &amp; Payments"
                                        alt="couple laying on floor looking at house blueprints" width="116px"
                                        height="116px">
                                </div>
                                <div class="b15avtar_content">
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#a3950571778" data-backdrop="false"
                            ...
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="{{ asset('assets/frontend/globalassets/images/secondary-icons/green/business-finance/green-business-_-finance-secondary-icon-21.png') }}"
                                ...
                                <div class="b15avtar_content">
                                    ...
                                    <p>We're a top Small Business Administration (SBA) lender. From small business loans to
                                        lines of credit, we can help.</p>
                                    <div class="clearfix"></div><br />
                                    <a
                                        href="../../../small-business/loans-and-credit-lines/small-business-loans/index.html">Learn
                                        More</a>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left:40px;">
                                                        ...
                                                        <div class="b46Blue" style="text-align:left;">
                                                            ...
                                                            <p><br /><a href="../../mortgages/index.html"
                                                                    target="_blank"></a></p>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <div class="b13points">
                                ...
                                <p>{2} When you overdraw your checking account, advances will be made in established
                                    increments.&nbsp; A $12 Overdraft Protection Fee will be assessed to your checking
                                    account for each automatic transfer from a First PREMIER Bank line of credit to cover an
                                    overdraft.&nbsp; This fee does not apply to any manual transfer such as by phone, in
                                    person or online, or to Reward Checking customers.</p>
                            </div>
                        </div>
                    </div>
                </section>

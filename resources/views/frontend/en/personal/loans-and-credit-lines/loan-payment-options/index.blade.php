...
<style>
    ...
    .b46productpage { float:left; width:100%; padding:80px 0px 50px 0px; text-align:center; background:#fff url(../../../../contentassets/c2ddbf9377124bb8838750921f7494c5/grey-2.svg) no-repeat;}
</style>
<section class="row-full">
    <div class="b46productpage">
        <div class="container">
            <h1>Paying Your Loan</h1>
                <img src="{{asset('assets/frontend/contentassets/c2ddbf9377124bb8838750921f7494c5/loan-page-header-image.jpg')}}" alt="First PREMIER Bank">
                            <h2>Your Options Are Open</h2>
            <p style="text-align: center;">Having options to fit your personal needs and preferences is important. That&rsquo;s why First PREMIER Bank offers several quick and convenient ways to make your consumer loan payment. Many of these can be done from the comfort of your home or from your mobile device. If you're looking for ways to pay your First PREMIER Credit Card, please visit <a href="https://www.mypremiercreditcard.com/">mypremiercard.com</a>.</p>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/e7bae471961b41198700e46395dc9831/loan-payments-online-banking.jpg')}}" title="Online Banking" alt="woman looking at laptop"></div>
                        </div>
...
<li>View balance information online</li>
                            ...
                            <!-- Button and Footer Links go here ... -->
                                        <a href="https://online.firstpremier.com/FirstPremierBankOnline_AutoEnroll/enroll.html" class="b16readmore">Enroll Today</a>
                            <!-- Button and Footer Links go here ... -->
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/98a47218f38e4b00b9084d256265b0bf/loan-payments-auto.jpg')}}" title="Automatic Payments" alt="woman looking at mobile phone"></div>
        ...
        <div class="b16basic_box_left_content b16basic_box_background">
            <div class="b16basic_box_main">
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/f3330bd8c6fb4e19b7a5ed86efa49116/loan-options-by-mail.jpg')}}" title="By Mail" alt="man wearing headset"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>By Mail</h2>
        ...
        <div class="b16basic_box_right_content b16basic_box_background">
            <div class="b16basic_box_main b16basic_box_grey">
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/af6734fbfe9245ec85996752bdc5b8d8/loan-payments-other-fis.jpg')}}" title="Payments From Other Banks" alt="woman looking at laptop"></div>
        ...
        <div class="b16basic_box_left_content b16basic_box_background">
            <div class="b16basic_box_main">
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/830a9e8d91db49f78a0a6105b0557031/loan-payments-by-phone.jpg')}}" title="Over the Phone" alt="man talking on the phone"></div>
                        </div>
                        <div class="b16basic_box_left">
...
<li>A $10 fee is assessed for customers using non-First PREMIER accounts to make payment.</li>
            ...
            <div class="b12container">
                ...
                <div class="tabbable">
                    <div class="tab-content col-md-7">
                        <div class="tab-pane active" id="A"><span>How do I enroll in Automatic Payments?</span><p><p>Contact us at 800-501-6535 to set up automatic payments through your primary financial institution.</p></p></div><div class="tab-pane" id="B"><span>How do I send via Bill Pay?</span><p><p>Use your primary financial institution&rsquo;s Bill Pay in your online banking. Please note, some institutions charge for Bill Pay. Refer to your product and service fee disclosure. Bill Pay Vendor Information:</p>
<p>First PREMIER Bank</p>
<p>PO Box 1348</p>
<p>Sioux Falls, SD 57101-1348</p>
<p>PH: 605-357-3002</p></p></div><div class="tab-pane" id="C"><span>Where can I enroll in Online Banking?</span><p><p>Enroll in First PREMIER Bank&rsquo;s Online Banking to make payments and view balance information. <a href="https://online.firstpremier.com/FirstPremierBankOnline_AutoEnroll/enroll.html">Enroll here.</a></p></p></div><div class="tab-pane" id="D"><span>What is the mailing address?</span><p><p>Mail payment with coupon to:</p>
<p>First PREMIER Bank</p>
<p>PO Box 1348</p>
<p>Sioux Falls, SD 57101-1348</p></p></div><div class="tab-pane" id="E"><span>How do I pay over the phone?</span><p><p>Loan payments can be made over the phone by calling Customer Care at 800-501-6535. Simply provide a checking or savings account number and our friendly operators will make the transfer. Please note there is a $10 fee for transfers made from non-First PREMIER accounts. Customers who make payments over the phone, using a First PREMIER account, will not be assessed the fee.</p></p></div>
                    </div>
                    <ul class="nav nav-pills nav-stacked col-md-5">
                        <li class="active"><a href="#A" data-toggle="tab">How do I enroll in Automatic Payments?</a></li><li><a href="#B" data-toggle="tab">How do I send via Bill Pay?</a></li><li><a href="#C" data-toggle="tab">Where can I enroll in Online Banking?</a></li><li><a href="#D" data-toggle="tab">What is the mailing address?</a></li><li><a href="#E" data-toggle="tab">How do I pay over the phone?</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<ul>
<li><a href="../personal-loans/index.html">Personal Loans</a></li>
<li><a href="../personal-lines-of-credit/index.html">Personal Lines of Credit</a></li>

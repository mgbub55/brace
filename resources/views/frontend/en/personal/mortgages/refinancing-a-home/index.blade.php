                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="{{ asset('assets/frontend/contentassets/468d7c8b405a420795e95b0b74178e2f/1.5.2_b-46-hero_family-min.png') }}"
                                alt="First PREMIER Bank">
                            <h2>Put Your Home Equity to Work for You</h2>
                            <p>If you&rsquo;re considering refinancing your home mortgage, First PREMIER Bank&rsquo;s
                                experienced mortgage lenders will work hard to find a financial solution that is right for
                                you, your family, and your budget.</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{ asset('assets/frontend/contentassets/0d65ea3bf2fe46e58c18333345089e62/1.5.3_b-16-list01_alternating-1_paper.png') }}"
                                                title="What is Your Goal?"
                                                alt="couple sitting on couch looking at bank statements"></div>
                                    </div>
                                    ...
                                    <div class="item active">
                                        <div class="row b6mypadding">
                                            <div class="b6featured_quote_img col-lg-5 col-md-5"><img
                                                    src="{{ asset('assets/frontend/contentassets/2a0dc9c37328471dac7b09d5aae7b3a3/quotes-dezmeadows.png') }}"
                                                    class="b6featured_img" alt="Dez Meadows Mortgage Banker"></div>
                                            <div class="b6featured_quote col-lg-7 col-md-7">
                                                <p>There are many reasons to refinance a home, and not all of them deal with
                                                    interest rates. Our experienced mortgage team can evaluate your personal
                                                    situation and help determine if refinancing is the best option for you.
                                                </p>
                                                <div class="clearfix"></div><span> - Dez Meadows, Mortgage
                                                    Banker</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="container">
                            ...
                            <div class="b17free_mobile_banking_left right">
                                <img class="img-responsive" id="imgMainImage" style="border-radius:50%"
                                    src="{{ asset('assets/frontend/contentassets/0efb0f2e0d814cfd898323725d89d4b5/1.5.2_b-17-promo_agent-min.png') }}"
                                    alt="First PREMIER Bank">
                            </div>
                        </div>
                    </div>

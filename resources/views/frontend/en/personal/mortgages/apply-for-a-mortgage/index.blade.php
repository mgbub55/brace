...
<section class="row-full">
    <div class="b46productpage">
        <div class="container">
            <h1>Online Mortgage Application</h1>
                <img src="{{asset('assets/frontend/contentassets/36a70fc110ae4d0bbafbca1efe6c0e69/1.5.3_b-46-hero_couchcouple-min.png')}}" alt="First PREMIER Bank">
                            <h2>Easy &amp; Secure Online Application</h2>
            <p>Applying for a mortgage online with First PREMIER is quick and easy using our state-of-the-art tools. Plus, we make our decisions locally, based upon the information you provide.</p>
<p style="text-align: center;"><strong><span style="text-decoration: underline;">Please read this page carefully to speed your loan application process.</span></strong></p>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/791a94132ea84735820c8abc7d22bfd3/1.5.3_b-16-list01_alternating-2_guy-min.png')}}" title="Easy Online Application" alt="man smiling"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>Easy Online Application</h2>

                                <div class="xhtml"><ul>
<li>Encrypted and secure online application</li>
<li>Ability to save and return later to complete your forms</li>
<li>Password-protected online access to check application status</li>
<li>Confirmation sent upon submission</li>
<li>Lending decisions made locally</li>
</ul></div>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/6c8bd869e1a040fd96e9cc848e9d1dd2/1.5.3_b-16-list01_alternating-1_paper-min.png')}}" title="Working with a Specific Banker?" alt="couple sitting on couch looking at bank statements"></div>

                        </div>
                        <div class="b16basic_box_left payIcon-space">
                            <h2 style="padding-top:0px !important;">Working with a Specific Banker?</h2>
                                <div class="xhtml"><p>It's easy to route your loan application directly to your mortgage banker. Simply find your banker's name on our <a title="Team Page" href="../../../pages/about-us/teams/mortgage-banking-team/index.html">Team Page</a>, click "APPLY NOW" and our state-of-the-art technology will do the rest.</p></div>
        ...
        <div class="b16basic_box_left_content b16basic_box_background">
            <div class="b16basic_box_main">
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/92c97503cf494091b77aed017b4a1b3d/1.5.3_b-16-list01_alternating-4_family-min.png')}}" title="What You Will Need" alt="mother holding daughter"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>What You Will Need</h2>

                                <div class="xhtml"><p>Information for all borrowers, including:<br /><br /></p>
<ul>
...
<section class="row-full">
        ...
        <div class="b25need_help_main">
            <div class="container">
                ...
                <div class="xhtml"><p>If you have your information ready, you can start your application now!</p></div>
                <div class="b25bottom" style="">
                    <center>
                    <a href="https://firstpremier.mymortgage-online.com/?loanapp&amp;siteid=9621968476&amp;workFlowId=81187" class="b25mainanchor">APPLY NOW</a><br clear="all"/>
                        <div class="b25footerlinks">
                                <center>
                                    <a class="b25mainanchorLink" href="../../../pages/about-us/teams/mortgage-banking-team/index.html">Contact Us</a>
                                </center>
                        </div>
                    </center>
                </div>
        ...
        <div class="b16basic_box_right_content b16basic_box_background">
            <div class="b16basic_box_main b16basic_box_grey">
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/5b2a5a105f754d1fbea46ec128d6e388/1.5.3_b-16-list01_alternating-3_couple-min.png')}}" title="After You Have Finished" alt="couple filling out mortgage application online"></div>

                        </div>
                        <div class="b16basic_box_left payIcon-space">
                            <h2 style="padding-top:0px !important;">After You Have Finished</h2>
                                <div class="xhtml"><p>We'll contact you to:</p>
<ul>
...
<section class="row-full b4background">
    <div class="container">
        <div class="b4anywhere_banking" style="width:100%; ">
                                        <div class="xhtml"><div class="bottom">&nbsp;</div></div>
                    </div>
    </div>
</section>
<script>

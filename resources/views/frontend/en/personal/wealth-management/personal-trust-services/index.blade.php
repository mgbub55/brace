        ...
        <div class="row equal-height">
            <div class="block b46block  col-md-12">
                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            <h1>Personal Trust Services</h1>
                            <img src="{{ asset('assets/frontend/contentassets/aaf315961deb4f33ba422f04bf229488/1.7.4_b-46-subpage-hero-01-benefits_couopledeal-min.png') }}"
                                alt="First PREMIER Bank">
                            <h2>The PREMIER Approach</h2>
                            <p>Protect your assets and provide for the people and causes you care about most with Estate
                                Planning and Personal Trust Services from First PREMIER Bank.</p>

                            <a href="https://icp.infovisa.com/0309" class="b46button">Log Into Trust Online</a>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{ asset('assets/frontend/contentassets/3864ba0e78ad435592a74fde067ab56b/1.7.4_b-16-list-01-alternating-1_manoffice-min-right.png') }}"
                                                title="Planning for Life&#39;s Transitions" alt="man sitting at desk"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>Planning for Life&#39;s Transitions</h2>

                                        <div class="xhtml">
                                            <p>As one of the strongest capitalized banks in the nation, First PREMIER Bank
                                                has extensive trust services expertise, managing $2.8 billion in trust
                                                assets. Our trust advisors can help you realize the <a title="SD Trust"
                                                    href="../trusts-in-south-dakota/index.html" target="_top">unique
                                                    benefits of establishing a trust in the state of South Dakota</a>.
                                                Working collaboratively with your attorney, accountants and other advisors,
                                                we can help develop a plan that protects and manages your assets and ensures
                                                your estate transitions according to your wishes.</p>
                                        </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="{{ asset('assets/frontend/contentassets/b84cc569439b4468a25d72aca12670f1/1.7.4_b-16-list-01-alternating-2_woman.png') }}"
                                                title="Benefits of a Trust" alt="woman smiling"></div>

                                    </div>
                                    <div class="b16basic_box_left payIcon-space">
                                        <h2 style="padding-top:0px !important;">Benefits of a Trust</h2>
                                        <div class="xhtml">
                                            <ul>
                                                <li>Avoid the time and expense of public probate</li>
                                                <li>Minimize potential tax implications&nbsp;</li>
                                                <li>Distribute your estate based on your wishes&nbsp;</li>
                                                <li>Distribute assets privately and efficiently</li>
                                                <li>Establish provision for bill payment, elder care and disability</li>
                                                <li>Provide for family, friends and favorite charitable causes</li>
                                            </ul>
                                        </div>

                                        <!-- Button and Footer Links go here ... -->
                                        <div class="b16confidence_links_multiple">
                                            <a href="../../../pages/about-us/teams/wealth-management-team/index.html"
                                                class="b16readmore">CONTACT US</a>
                                            <div class="clearfix"></div>
                                            <ul>
                                                <li><a class="b16multilink" href="../trusts-in-south-dakota/index.html"
                                                        title="South Dakota Trust">Benefits of a South Dakota Trust</a></li>
                                            </ul>
                                        </div>
                                        <!-- Button and Footer Links go here ... -->
                                    </div>
                        ...
                        <div class="b16basic_box_main">
                            <div class="container">
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{ asset('assets/frontend/contentassets/1ac2e57d6fe64cd096d72308c4a1d84e/1.7.4_b-16-list-01-alternating-3_womanphone.png') }}"
                                                title="PREMIER Supports You" alt="woman using mobile phone"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>PREMIER Supports You</h2>

                                        <div class="xhtml">
                                            <p>We work collaboratively with you, trusted family members, attorneys,
                                                accountants and advisors to:<br /><br /></p>
                                            <ul>
                                                <li>Identify opportunities for you and your family</li>
                                                <li>Discuss estate and inheritance planning</li>
                                                <li>Determine contingency plans in the event of disability or death</li>
                                                <li>Identify the right trust solution for your needs</li>
                                                <li>Administer the trust based on your wishes</li>
                                                <li>Provide full access to your trust via <a title="Trust Online"
            ...
            <div class="block b18block  col-md-12">
                ...
                <section>
                    <div class="b18great_feature_main">
                        ...
                        <div class="b18great_feature_left">
                            <div class="b18detail xhtml">
                                <p>Our Wealth and Trust Specialists are vested in your success and provide unparalleled
                                    personal service and experience on which you can rely. Call us to learn how we can help
                                    you develop a plan to grow and manage your money today.</p>
                            </div>
                        </div>
                        <div class="b18great_feature_left b18great_feature_right payIcon-space">
                            ...
                            <div class="b18detail xhtml">
                                <ul>
                                    <li><a title="SD Trusts" href="../trusts-in-south-dakota/index.html" target="_top">South
                                            Dakota Trusts</a></li>
                                    <li><a title="Private Banking" href="../private-banking/index.html"
                                            target="_top">Private Banking</a></li>
                    ...
                    <div id="a3459396" class="modal fade" role="dialog">
                    ...
                    <div id="b3459396" class="modal fade" role="dialog">
                        <div class="modal-dialog pop_board">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="pop_main_container_board">
                    ...
                    <div id="c3459396" class="modal fade" role="dialog">
                        <div class="modal-dialog pop_board">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="pop_main_container_board">
                ...
                <section class="row-full">
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <h4> Disclosure </h4>
                            <div class="b13points">
                                <p>Non-Deposit Investment Products | Not insured by the FDIC | No Bank Guarantee | May Lose
                                    Value</p>
                                <p>&nbsp;</p>
                                <p>&nbsp;</p>
                            </div>

                    ...
                    <form method="get">
                        <div class="b47hero_banner2">
                            ...
                            <img class="b47hero-img2"
                                src="{{ asset('assets/frontend/contentassets/2238732c880e4a6391c5002c1c6fb7cb/1.7.4.1_b-47-hero_advisor.png') }}"
                                alt="&quot;&quot;">
                            <div class="b47banner-desc2">
                                <div class="container">
                                    <div class="b47hero_banner_text2">
                                        <h1>Trusts in South Dakota</h1>
                                        <p>We help our clients leverage "wealth friendly" South Dakota tax and trust laws.
                                            Explore the benefits of establishing your trust in the state of South Dakota
                                            with First PREMIER Bank.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{ asset('assets/frontend/contentassets/6c1506e0601648c0befe1642abc3e469/1.7.4.1_b-16-list_01_alternating-1_advisor-min.png') }}"
                                                title="First PREMIER Bank: A Leader in Trust Services"
                                                alt="woman talking to couple"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>First PREMIER Bank: A Leader in Trust Services</h2>

                                        <div class="xhtml">
                                            <p>The unique laws of South Dakota create a favorable environment for wealth,
                                                estate and trusts. Harness these benefits and more by working with First
                                                PREMIER Bank Trust Services. We manage $2.8 billion in trust assets, helping
                                                individuals, families, businesses, non-profits, foundations and endowments.
                                            </p>
                                        </div>
                    ...
                    <div class="b22additional-lending">
                        <div class="container" style="padding-top:30px;">
                            ...
                            <div class="b22additional-lending-left">
                                ...
                                <div class="xhtml">
                                    <p>Ensure your estate transfers seamlessly and according to your wishes, easing the
                                        transition of loved ones at a difficult time. Learn more about personal trusts from
                                        First PREMIER Bank.</p>
                                </div>
                                <a href="../personal-trust-services/index.html">Learn More</a>
                            </div>

                            <div class="b22additional-lending-righ">
                                <h3>Business Trust Services</h3>
                                <div class="xhtml">
                                    <p>First PREMIER Bank works with business owners and their teams, including accounting,
                                        legal and advisors to help with estate and business contingency planning.</p>
                                </div>
                                <a
                                    href="../../../small-business/asset-management-and-trust/business-trust-services/index.html">Learn
                                    More</a>
                            </div>
                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left:40px;">
                                                        ...
                                                        <div class="b46Blue" style="text-align:left;">
                                                            ...
                                                            <p><br /><a href="../personal-trust-services/index.html"
                                                                    target="_blank"></a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left:40px;">
                                                        ...
                                                        <div class="b46Blue" style="text-align:left;">
                                                            ...
                                                            <p><br /><a
                                                                    href="../../../small-business/asset-management-and-trust/business-trust-services/index.html"
                                                                    target="_blank"></a></p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="{{ asset('assets/frontend/contentassets/6ebf5c7de37d4c0b9eeb7056441bd6ee/1.7.4.1_b-16-list_01_alternating-2_family-min.png') }}"
                                                title="Dynasty Trusts" alt="family sitting on porch step"></div>

                                    </div>
                                    <div class="b16basic_box_left payIcon-space">
                                        <h2 style="padding-top:0px !important;">Dynasty Trusts</h2>
                                        <div class="xhtml">
                                            <p>A unique, generation skipping trust that can be established to provide
                                                financial security for future generations. Most states enforce time limits
                                                on the duration of trusts. However, in the state of South Dakota, Dynasty
                                                Trusts have no limit on perpetuity.</p>
                                        </div>
                    ...
                    <div class="b18great_feature_main">
                        ...
                        <div class="b18great_feature_left">
                            ...
                            <div class="b18detail xhtml">
                                <p>A Special Needs Trust permits certain South Dakota residents with disabilities under the
                                    age of 65<sup>1</sup> to establish an account holding their own funds to preserve
                                    eligibility for Medicaid, Social Security and/or government benefits - without the
                                    transfer penalties normally accessed.<sup>2</sup></p>
                            </div>
                        </div>
                        <div class="b18great_feature_left b18great_feature_right payIcon-space">
                            ...
                            <div class="b18detail xhtml">
                                <ul>
                                    ...
                                    <li>Spendthrift provisions to protect assets against creditor claims against a
                                        beneficiary</li>
                ...
                <section class="row-full">
                    ...
                    <div class="b25need_help_main">
                        <div class="container">
                            ...
                            <div class="xhtml">
                                <p>Speak with a Trust Specialist today to learn how</p>
                                <p>First PREMIER can assist with proactive estate</p>
                                <p>planning and trust services.</p>
                            </div>
                ...
                <section class="row-full">
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <h4> Disclosures </h4>
                            <div class="b13points">
                                <p>{1} Qualified individuals must be under the age of 65 as approved by the rules of special
                                    needs trust, the court and trustee.</p>
                                <p>{2}&nbsp;Funding a beneficiary&rsquo;s account does not result in &ldquo;transfer
                                    penalties&rdquo;&nbsp; for Medicaid eligibility purposes and, once assets are held in a
                                    account, they are not considered available resources for purposes of most means-tested
                                    government benefits (e.g. Medicaid and SSI).</p>
                                <p>{3} Medicaid Payback is required to the extent that the beneficiary received Medicaid
                                    Long Term Care benefits prior to death.</p>
                                <p>{4} Funds remaining after a beneficiary&rsquo;s death and any required Medicaid payback
                                    are distributed to heirs or loved ones identified in the beneficiary&rsquo; joinder
                                    agreement.</p>

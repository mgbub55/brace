                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    ...
                                    <div class="b16basic_box_left">
                                        ...
                                        <div class="b16confidence_links">
                                            <a href="{{ route('frontend.en.pages.resources.forms.apply-now') }}"
                                                class="b16readmore">Apply Now</a>
                                            <a class="b16mainlink"
                                                href="{{  route('frontend.en.personal.personal-checking.free-plus-checking')  }}">Learn More</a>
                                        </div>
                                        <!-- Button and Footer Links go here ... -->
                                    </div>
                                </div>
                            ...
                            <div class="container">
                                <div class="b16basic_box">
                                    ...
                                    <div class="b16basic_box_left payIcon-space">
                                        ...
                                        <!-- Button and Footer Links go here ... -->
                                        <a href="{{ route('frontend.en.personal.students-and-parents.student-loans') }}" class="b16readmore">Learn More</a>
                                        <!-- Button and Footer Links go here ... -->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container">
                                <div class="b16basic_box b16basic_box_position">
                                    ...
                                    <div class="b16basic_box_left">
                                        ...
                                        <!-- Button and Footer Links go here ... -->
                                        <a href="{{ route('frontend.en.personal.students-and-parents.university-debit-cards') }}"" class="b16readmore">Learn More</a>
                                        <!-- Button and Footer Links go here ... -->
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="b25need_help_main">
                        <div class="container">
                            ...
                            <div class="b25bottom" style="">
                                <center>
                                    <a href="{{ route('frontend.en.pages.about-us.community.collegiate-support.scholarship-and-internships') }}"
                            ...
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                ...
                                <div class="b15avtar_content">
                                    ...
                                    <p>First PREMIER Bank is a proud supporter of higher education. See how we&rsquo;re
                                        ...
                                        state.</p>
                                    <div class="clearfix"></div><br />
                                    <a href="{{ route('frontend.en.pages.about-us.community.collegiate-support.scholarship-and-internships') }}">Learn
                                        More</a>
                                </div>
                            </div>
                        </div>

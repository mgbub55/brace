                ...
                <section class="row-full b4background">
                    <div class="container">
                        <div class="b4anywhere_banking" style="width:100%; ">
                            <h2 style="text-align:left !important;">University Debit Mastercards&#174;</h2>
                            <div class="xhtml">
                                <p><img src="{{ asset('assets/frontend/contentassets/683405e793814215b3d7980bfcb4dad1/university-debit-card-header.jpg') }}"
                                        alt="University Debit Card Header.jpg" width="1200" height="415" /></p>
                                <p>First PREMIER Bank University branded Debit Mastercards&reg; let you show your school
                                    spirit with every swipe. University debit cards are free with any First PREMIER checking
                                    account and ideal for students, parents, alumni, faculty and staff.<br /><br /></p>
                                <h2><strong>First PREMIER Bank Checking Accounts Feature</strong><strong>:</strong></h2>
                                <ul>
                                    <li>Online account opening<sup>1</sup></li>
                                    <li>Instant Issue debit cards at available locations<sup>2</sup></li>
                                    <li>24/7 Fraud Monitoring</li>
                                    <li>Chip technology/EMV Cards</li>
                                    <li>Zero Liability&reg; Protection for all debit card purchases</li>
                                    <li>Text and email account alerts</li>
                                    <li>Instant debit card lock/unlock within online or mobile banking</li>
                                </ul>
                                <p>&nbsp;</p>
                                <p>If you already have an account, stop by any branch<sup>2</sup> to ask for a Dakota State
                                    University or Coyote Debit Mastercard. If you&rsquo;re not currently a First PREMIER
                                    Bank customer, <a href="../../../pages/resources/forms/apply-now/index.html">apply
                                        online for FREE+ Checking here</a>, or <a
                                        href="../../../pages/quick-links/locations/index.html">stop by any branch
                                        location</a> to open your checking account and request a DSU or Coyote Debit
                                    Mastercard<sup>2</sup>.<br /><br /></p>
                                <h3 style="text-align: center;"><a
                                        href="../../../pages/resources/forms/apply-now/index.html">Apply for FREE+ Checking
                                        Now</a></h3>
                                <h2><strong>Student Loans</strong></h2>
                                <p>Need help paying for college tuition? We've partnered with Ascent to help provide
                                    cosigned and non-cosigned student loans.<br /><br /><a
                                        href="../student-loans/index.html">LEARN MORE &gt;</a></p>
                                <p>&nbsp;</p>
                                <h2>See Also:</h2>
                                <ul>
                                    <li><a href="../../../pages/about-us/community/collegiate-support/index.html">Collegiate
                                            Support</a></li>
                                    <li><a href="../index.html">Students and Parents</a></li>
                                    <li><a href="../../personal-checking/debit-card/index.html">Personal Debit
                                            Mastercard</a></li>
                                </ul>
                                <p>&nbsp;</p>
                                <p><br /><br /></p>
                ...
                <section class="row-full">
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <h4> Disclosures </h4>
                            <div class="b13points">
                                <p>{1} You must be a resident of South Dakota, Iowa, Nebraska or Minnesota to apply online.
                                </p>
                                <p>{2} Instant issue is not available at the following branches: Wakonda, Lake Norden,

...
<style>
    ...
    .b46productpage { float:left; width:100%; padding:80px 0px 50px 0px; text-align:center; background:#fff url(../../../../Static/img/Pages/P2/grey-1.svg) no-repeat;}
</style>
<section class="row-full">
    <div class="b46productpage">
        <div class="container">
            <h1>PREMIER Kids Club Savings</h1>
                <img src="{{asset('assets/frontend/contentassets/baac7ba99dab4b4f8277957ded4045dc/kids-club-header.jpg')}}" alt="First PREMIER Bank">
                            <h2>Start Your Savings Story</h2>
            <p>Bring your pennies, nickels, dimes and quarters to First PREMIER Bank. Earn great interest on your balance and have fun as you learn simple money concepts. Download our free mobile app and play along with Penny, Peso and the PREMIER Pals to see how slow and steady not only wins the race, but also helps you reach your savings goals.</p>

                        <a href="../../../pages/resources/forms/apply-now/index.html" class="b46button">Apply Online</a>
...
<table style="width: 100%; height: 136px; border-collapse: collapse;" border="1">
<tbody>
...
<td style="width: 20.88%; height: 82px; text-align: center;">PREMIER Kids Club Savings Account<sup>1</sup></td>
<td style="width: 11.95%; height: 82px; text-align: center;">$50.00</td>
<td style="width: 11.65%; height: 82px; text-align: center;">1.00%</td>
<td style="width: 12.83%; height: 82px; text-align: center;">1.00%</td>
</tr>
</tbody>
</table>
</div>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/58fdf70701aa4bd2805f0c98cfcfc9c4/open-a-kids-club-savings-account.jpg')}}" title="Open a PREMIER Kids Club Savings Account " alt="child putting coins in piggy bank"></div>
                        </div>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="{{asset('assets/frontend/contentassets/4797b3b3218a4d10b6085a056ac09f83/appsolutely-awesome.jpg')}}" title="App-solutely Awesome" alt="father and daughter putting coins in piggy bank"></div>

                        </div>
                        <div class="b16basic_box_left payIcon-space">
                            <h2 style="padding-top:0px !important;">App-solutely Awesome</h2>
                                <div class="xhtml"><p>Download the free PREMIER Kids Club mobile app with Penny, Peso and all their friends and have fun while you learn. The app features age-appropriate games to teach simple concepts related to money. <br /><br /></p>
<ul>
<li>Works on most phones and tablets</li>
<li>New lessons added quarterly</li>
<li>Parental Controls</li>
<li>Does not link directly to accounts at First PREMIER Bank or any other financial institution<br /><br /></li>
</ul>
<p><br /><a href="https://apps.apple.com/us/app/premier-kids-club/id1501891716" target="_blank" rel="noopener"><img src="{{asset('assets/frontend/globalassets/images/store_apple-min.png')}}" alt="" width="192" height="57" /></a>&nbsp; &nbsp;<a href="https://play.google.com/store/apps/details?id=com.htmobileapps.premierkidsclub" target="_blank" rel="noopener"><img src="{{asset('assets/frontend/globalassets/images/store_google-min.png')}}" alt="" width="194" height="58" /></a></p></div>
        ...
        <div class="container">
            ...
            <div class="b17free_mobile_banking_right">
                    <h3>Regular Savings with Interest</h3>
                                <div class="xhtml"><p>Bigger kids mean bigger dreams. At age 13, your PREMIER Kids Club account will roll into a First PREMIER Regular Savings Account. This great everyday account comes with Online and Mobile Banking, Mobile Deposit and more.</p></div>
                ...
                <div class="b17free_mobile_banking_left right">
                    <img class="img-responsive" id="imgMainImage" style="border-radius:50%" src="{{asset('assets/frontend/contentassets/e3b07bb0d71e41c48ee188539c09c574/save-happily-ever-after.jpg')}}" alt="First PREMIER Bank">
                </div>
        </div>
    </div>
        ...
        <div class="b15benfits_main_box b17cards">
            <div class="container">
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                <img src="{{asset('assets/frontend/globalassets/images/secondary-icons/green/business-finance/green-business-_-finance-secondary-icon-11.png')}}" title="PREMIER Money Market Savings" alt="couple looking at bank statement" width="116px" height="116px"></div>
                                <div class="b15avtar_content">
                                    <h3>PREMIER Money Market Savings</h3>
                                    <p>Earn tiered interest on savings over $500. The higher your balance, the better your rate.</p>
                            ...
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                <img src="{{asset('assets/frontend/globalassets/images/secondary-icons/blue/business-finance/blue-business-_-finance-secondary-icon-12.png')}}" title="Overdraft Protection" alt="couple looking at bank statement" width="116px" height="116px"></div>
                                <div class="b15avtar_content">
                                    <h3>Overdraft Protection</h3>
                                    <p>Ensure funds are in place to cover transactions! Use your savings account as overdraft protection<sup>2</sup>.</p>
                                    <div class="clearfix"></div><br />
...
<section class="row-full">
        <div class="b13what_you_know_main">
            <div class="container" style="background-color:#182e39 !important;">
                ...
                <h4> Disclosures </h4>
                <div class="b13points">
                    <p>{1} $2 per month if balance falls below $50 (no charge if on combined statement). Fees can reduce earnings on the account.</p>
<p>{2} Savings withdrawals are generally limited to six per month. You may make an unlimited number of withdrawals when made in person, by mail or at an automated teller machine (ATM). If the monthly withdrawal limit is exceeded, a fee of $1 for each excess withdrawal will be assessed. Fees can reduce earnings on the account.<br /><br /></p>
<p>Android, Google Pay, Google Play, and the Google Logo are trademarks of Google LLC. Apple, the Apple logo, iPhone, iPad, Apple Watch and Touch ID are trademarks of Apple Inc., registered in the U.S. and other countries. App Store is a service mark of Apple Inc.</p>
                </div>
            </div>
        </div>
</section></div></div>

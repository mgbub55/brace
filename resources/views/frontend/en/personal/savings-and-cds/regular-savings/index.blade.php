                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="{{ asset('assets/frontend/contentassets/ef49ec9da5014de182f41fabcdb36238/1.3.1_b-46-hero_couplecouch-min.png') }}"
                                alt="First PREMIER Bank">
                            <h2>Start Saving Today</h2>
                            <p>This traditional savings account is a great option for first-time or everyday savings. Your
                                account<br />can also be used for personal overdraft protection<sup>1</sup> and comes with
                                FREE Online and Mobile Banking.<br />(You must be a resident of South Dakota, Iowa, Nebraska
                                or Minnesota to apply online.)&nbsp;</p>
                                                        ...
                                                        <table style="height: 73px; width: 100%; border-collapse: collapse;"
                                                            ...
                                                            <tbody>
                                                                <tr style="height: 54px;">
                                                                    <td
                                                                        style="height: 54px; text-align: center; font-size: 14px; width: 25%;">
                                                                        Account<br />Product <br />Name</td>
                                                                    <td
                                                                        style="text-align: center; height: 54px; font-size: 14px; width: 25%;">
                                                                ...
                                                                <tr style="height: 19px;">
                                                                    <td
                                                                        style="height: 19px; text-align: center; width: 25%;">
                                                                        Regular Savings<sup>1</sup></td>
                                                                    <td
                                                                        style="text-align: center; height: 19px; width: 25%;">
                                                                        $50.00</td>
                                                                    <td
                                                                        style="text-align: center; height: 19px; width: 25%;">
                                                                        0.02%</td>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{ asset('assets/frontend/contentassets/a9845028f17b47a78ebf7ca44d018ee3/1.3.1_b-16-list01_alternating-1_lady-min.png') }}"
                                                title="Account Features" alt="woman looking at laptop"></div>
                                    </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="{{ asset('assets/frontend/contentassets/86fd2a9a2a8445358ec42cd8093177c6/1.3.1_b-16-list01_alternating-2_woman-min.png') }}"
                                                title="Rates &amp; Requirements" alt="woman working at desk"></div>
                                        ...
                                        <div class="table_rate_modal">
                                            <table style="height: 73px; width: 100%; border-collapse: collapse;" border="1">
                                                <tbody>
                                                    ...
                                                    <tr style="height: 19px;">
                                                        <td style="height: 19px; text-align: center; width: 25%;">Regular
                                                            Savings<sup>1</sup></td>
                                                        <td style="text-align: center; height: 19px; width: 25%;">$50.00
                                                        </td>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        if ('{{ asset("assets/frontend/Static/img/CustomBlocks/B25/Background.png") }}' != 'null' &&
                            '{{ "assets/frontend/Static/img/CustomBlocks/B25/Background.png" }}' != '') {
                            ...
                            if (screen.width > 1000) {
                                $(".b25need_help_main").css("background",
                                    "#245251 url({{ 'assets/frontend/Static/img/CustomBlocks/B25/Background.png' }}) no-repeat"
                                    );
                            }
                ...
                <section class="row-full">
                    ...
                    <div class="b25need_help_main">
                        <div class="container">
                            ...
                            <div class="xhtml">
                                <p>It's easy to get started today with our simple, secure online application.</p>
                            </div>
                    ...
                    <div class="b17free_mobile_banking ">
                        <div class="container">
                            ...
                            <div class="b17free_mobile_banking_right">
                                ...
                                <div class="xhtml">
                                    <p>Earn higher interest on higher balance savings with a PREMIER Money Market
                                        account.&nbsp; Open an account today with a minimum deposit of $500 and watch your
                                        money grow.</p>
                                </div>
                            ...
                            <div class="b17free_mobile_banking_left right">
                                <img class="img-responsive" id="imgMainImage" style="border-radius:50%"
                                    src="{{ asset('assets/frontend/contentassets/6772b4dc871c4bdd862b0717fad9adac/1.3.1_b-17-promo_couplemature-min-left.png') }}"
                                    alt="First PREMIER Bank">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="b15benfits_main_box b17cards">
                        <div class="container">
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="{{ asset('assets/frontend/globalassets/images/secondary-icons/gold/business-finance/gold-business-_-finance-secondary-icon-12.png') }}"
                                        title="Overdraft Protection" alt="couple looking at document" width="116px"
                                        height="116px">
                                </div>
                            ...
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="{{ asset('assets/frontend/globalassets/images/secondary-icons/bright/business-finance/bright-business-_-finance-secondary-icon-41.png') }}"
                                        title="Saving for Kids" alt="couple looking at document" width="116px"
                                        height="116px">
                                </div>
                                <div class="b15avtar_content">
                    ...
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <div class="b13points">
                                ...
                                <p>{2} $2 per month if balance falls below $50 (no charge if on combined statement). Fees

                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="{{ asset('assets/frontend/contentassets/2f96adf307e04395a551631677dab161/1.3.2_b-46_family.png') }}"
                                alt="First PREMIER Bank">
                            <h2>Higher Interest on Higher Balances</h2>
                            <p>A great option for individuals who expect premium interest on higher balances.&nbsp;<br />Use
                                your account for overdraft protection<sup>1</sup> and get FREE Online and Mobile Banking.
                            </p>
                                            ...
                                            <div class="pop_main_container_board">
                                                ...
                                                <div class="pop_main_container">
                                                    ...
                                                    <div class="table_rate_modal">
                                                        <table
                                                            style="width: 100%; height: 237px; border-collapse: collapse;"
                                                            border="1">
                                                            <tbody>
                                                                <tr style="height: 54px;">
                                                                    <td
                                                                        style="height: 54px; text-align: center; font-size: 14px; width: 40%;">
                                                                        Account<br />Product <br />Name</td>
                                                                    <td
                                                                        style="text-align: center; height: 54px; font-size: 14px; width: 20%;">
                                                                ...
                                                                <tr style="height: 19px;">
                                                                    <td style="height: 19px; width: 40%;">PREMIER Money
                                                                        Market<sup>1,2<br /></sup></td>
                                                                    <td
                                                                        style="text-align: center; height: 19px; width: 20%;">
                                                                        $500.00</td>
                                                                    <td
                                                                        style="text-align: center; height: 19px; width: 20%;">
                                                                        &nbsp;</td>
                                                                ...
                                                                <tr style="height: 18px;">
                                                                    <td
                                                                        style="text-align: center; height: 18px; width: 40%;">
                                                                        Daily Balances of:</td>
                                                                    <td
                                                                        style="text-align: center; height: 18px; width: 20%;">
                                                                        &nbsp;</td>
                                                                    <td
                                                                        style="text-align: center; height: 18px; width: 20%;">
                                                                        &nbsp;</td>
                                                                ...
                                                                <tr style="height: 18px;">
                                                                    <td
                                                                        style="text-align: right; height: 18px; width: 40%;">
                                                                        $0.00 to $9,999.99</td>
                                                                    <td
                                                                        style="text-align: center; height: 18px; width: 20%;">
                                                                        &nbsp;</td>
                                                                ...
                                                                <tr style="height: 20px;">
                                                                    <td
                                                                        style="text-align: right; height: 20px; width: 40%;">
                                                                        $10,000.00 - $24,999.99</td>
                                                                    <td
                                                                        style="text-align: center; height: 20px; width: 20%;">
                                                                        &nbsp;</td>
                                                                    <td
                                                                        style="text-align: center; height: 20px; width: 20%;">
                                                                        0.02%</td>
                                                    ...
                                                    <p><br />&nbsp; Fees could reduce the earnings on the
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{ asset('assets/frontend/contentassets/34710ce0ddbf46c29b25035a9f9dda7b/1.3.2_b-16-list01_alternating-1_lady-min-right.png') }}"
                                                title="Account Features" alt="woman writing at desk"></div>
                                    </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="{{ asset('assets/frontend/contentassets/7960263db9ca4b73af27e5baa25dd29b/1.3.2_b-16-list01_alternating-2_couple-min1.png') }}"
                                                title="Rates &amp; Requirements" alt="couple smiling looking at laptop">
                                        </div>
                            ...
                            <div class="modal-body">
                                <div class="pop_main_container_board">
                                    ...
                                    <div class="pop_main_container">
                                        ...
                                        <p style="text-align: center;">&nbsp;</p>
                                        <div class="table_rate_modal">
                                            <table style="width: 100%; height: 237px; border-collapse: collapse;"
                                                border="1">
                                                <tbody>
                                                    <tr style="height: 54px;">
                                                        <td
                                                    ...
                                                    <tr style="height: 19px;">
                                                        <td style="height: 19px; width: 40%;">PREMIER Money
                                                            Market<sup>1,2<br /></sup></td>
                                                        <td style="text-align: center; height: 19px; width: 20%;">$500.00
                                                        </td>
                                                        <td style="text-align: center; height: 19px; width: 20%;">&nbsp;
                                                        </td>
                                                        <td style="text-align: center; height: 19px; width: 20%;">&nbsp;
                                                        </td>
                                                    </tr>
                                                    <tr style="height: 18px;">
                                                        <td style="text-align: center; height: 18px; width: 40%;">Daily
                                                            Balances of:</td>
                                                        <td style="text-align: center; height: 18px; width: 20%;">&nbsp;
                                                        </td>
                                                        <td style="text-align: center; height: 18px; width: 20%;">&nbsp;
                                                        </td>
                                                        <td style="text-align: center; height: 18px; width: 20%;">&nbsp;
                                                    ...
                                                    <tr style="height: 18px;">
                                                        <td style="text-align: right; height: 18px; width: 40%;">$0.00 to
                                                            $9,999.99</td>
                                                        <td style="text-align: center; height: 18px; width: 20%;">&nbsp;
                                                        </td>
                                                    ...
                                                    <tr style="height: 20px;">
                                                        <td style="text-align: right; height: 20px; width: 40%;">$10,000.00
                                                            - $24,999.99</td>
                                                        <td style="text-align: center; height: 20px; width: 20%;">&nbsp;
                                                        </td>
                                                        <td style="text-align: center; height: 20px; width: 20%;">0.02%</td>
                                                        <td style="text-align: center; height: 20px; width: 20%;">0.02%</td>
                                                    </tr>
                                                    <tr style="height: 18px;">
                                                        <td style="text-align: right; height: 18px; width: 40%;">$25,000.00
                                                            - $49,999.99</td>
                                                        <td style="text-align: center; height: 18px; width: 20%;">&nbsp;
                                                        </td>
                                                    ...
                                                    <tr style="height: 18px;">
                                                        <td style="text-align: right; height: 18px; width: 40%;">$50,000.00
                                                            - $99,999.99</td>
                                                        <td style="text-align: center; height: 18px; width: 20%;">&nbsp;
                                                        </td>
                                                    ...
                                                    <tr style="height: 18px;">
                                                        <td style="text-align: right; height: 18px; width: 40%;">$100,000.00
                                                            - $249,999.99</td>
                                                        <td style="text-align: center; height: 18px; width: 20%;">&nbsp;
                                                        </td>
                                                    ...
                                                    <tr style="height: 18px;">
                                                        <td style="text-align: right; height: 18px; width: 40%;">$250,000.00
                                                            - $499,999.99</td>
                                                        <td style="text-align: center; height: 18px; width: 20%;">&nbsp;
                                                        </td>
                                                    ...
                                                    <tr style="height: 18px;">
                                                        <td style="text-align: right; height: 18px; width: 40%;">$500,000.00
                                                            - $999,999.99</td>
                                                        <td style="text-align: center; height: 18px; width: 20%;">&nbsp;
                                                        </td>
                                                    ...
                                                    <tr style="height: 18px;">
                                                        <td style="text-align: right; height: 18px; width: 40%;">
                                                            $1,000,000.00+</td>
                                                        <td style="text-align: center; height: 18px; width: 20%;">&nbsp;
                                                        </td>
                                        ...
                                        <p style="text-align: left;"><sup>2</sup>Daily balance. The amount of the principal
                                            in the account each day</p>
                                        <p><br />&nbsp; Fees could reduce the earnings on the account<br />&nbsp; Interest
                                            Rates and Annual Percentage Yields are current as of June 1, 2021<br />&nbsp;
                                            For current rate information, call (605) 357-3000</p>
                                        <p>&nbsp;</p>
                                        <p>&nbsp; Member<br />&nbsp; FDIC</p>
                    ...
                    <div class="b17free_mobile_banking ">
                        <div class="container">
                            ...
                            <div class="b17free_mobile_banking_right">
                                ...
                                <div class="xhtml">
                                    <p>Use your PREMIER Money Market account as overdraft protection<sup>1</sup> for your
                                        First PREMIER Bank checking account, and ensure funds are always in place to cover
                                        your transactions.&nbsp;</p>
                                </div>
                                ...
                                <!-- Button and Footer Links go here ... -->
                                <a href="../../personal-checking/overdraft-protection/index.html"
                                    class="b17readmore">Learn More</a>
                            </div>

                            <div class="b17free_mobile_banking_left right">
                                <img class="img-responsive" id="imgMainImage" style="border-radius:50%"
                                    src="{{ asset('assets/frontend/contentassets/8a359ae079734fbc9a3718a1841eed12/1.3.2_b-17-text-with-image_malecchand-min.png') }}"
                                    alt="First PREMIER Bank">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="b15benfits_main_box b17cards">
                        <div class="container">
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="{{ asset('assets/frontend/globalassets/images/secondary-icons/bright/business-finance/bright-business-_-finance-secondary-icon-15.png') }}"
                                        title="Regular Savings" alt="mobile phone" width="116px" height="116px">
                                </div>
                            ...
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="{{ asset('assets/frontend/globalassets/images/secondary-icons/gold/business-finance/gold-business-_-finance-secondary-icon-41.png') }}"
                                        title="Saving for Kids" alt="mobile phone" width="116px" height="116px">
                                </div>
                                <div class="b15avtar_content">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left:40px;">
                                                        ...
                                                        <div class="b46Blue" style="text-align:left;">
                                                            ...
                                                            <p><br /><a
                                                                    href="../../personal-checking/overdraft-protection/index.html"
                                                                    target="_blank"></a></p>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <div class="b13points">
                                <p>{1} Savings withdrawals are generally limited to six per month. You may make an unlimited
                                    number of withdrawals in person, by mail or at an automated teller machine (ATM). If the
                                    monthly withdrawal limit is exceeded, a fee of $1 for each excess withdrawal will be
                                    assessed. Fees can reduce earnings on the account.</p>
                            </div>
                        </div>
                    </div>
                </section>

    ...
    <div class="b46productpage">
        <div class="container">
            <h1>Certificates of Deposit</h1>
                <img src="{{asset("assets/frontend/contentassets/4bdcdf8ad9264339a7a0449441906b74/1.3.4_b-46-hero_couplemature-min.png")}}" alt="First PREMIER Bank">
                            <h2>Lock in a Great Rate Today</h2>
            <p>Saving for something specific or just looking to maximize your rate of return? First PREMIER Bank has an array of term options and can help you lock in a great rate on a CD today.</p>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="{{asset('assets/frontend/contentassets/a571d0fcad314b17800050b0edff0ae7/1.3.4_b-17-promo_womantablet-min-right.png')}}" title="Features &amp; Benefits" alt="woman looking at features of CD&#39;s on laptop"></div>
                        </div>
...
<li>One of the lowest opening minimums in the market at just $500 minimum deposit<sup>2</sup></li>
<li>We&rsquo;ll help you pick the right option</li>
<li>FDIC Insured</li>
</ul></div>
                            <!-- Button and Footer Links go here ... -->
                                        <a href="#" data-toggle="modal" data-target="#myModal" class="b16readmore">View Terms and Rates</a>
                            <!-- Button and Footer Links go here ... -->
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="b17free_mobile_banking_right">
                    <h3>PREMIER Money Market</h3>
                                <div class="xhtml"><p>Save money while earning more on higher balance savings accounts. The higher your balance, the better your interest rate. Open an account today with a minimum deposit of $500 and watch your money grow.&nbsp;</p></div>
                ...
                <div class="b17free_mobile_banking_left right">
                    <img class="img-responsive" id="imgMainImage" style="border-radius:50%" src="{{asset("assets/frontend/contentassets/c56ae31fcb054c0b96cb3b255ba6682b/1.3.1_b-17-promo_couplemature-min-left.png")}}" alt="First PREMIER Bank">
                </div>
        </div>
    </div>
        ...
        <div class="b15benfits_main_box b17cards">
            <div class="container">
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                <img src="{{asset('assets/frontend/globalassets/images/secondary-icons/bright/business-finance/bright-business-_-finance-secondary-icon-12.png')}}" title="Overdraft Protection" alt="couple looking at money market document" width="116px" height="116px"></div>
                            ...
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                <img src="{{asset('assets/frontend/globalassets/images/secondary-icons/gold/business-finance/gold-business-_-finance-secondary-icon-41.png')}}" title="Savings for Kids" alt="couple looking at money market document" width="116px" height="116px"></div>
                                <div class="b15avtar_content">

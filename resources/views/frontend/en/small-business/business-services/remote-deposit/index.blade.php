    ...
    <div class="b46productpage">
        <div class="container">
            <h1>Remote Deposit</h1>
                <img src="../../../../contentassets/7416253cb65f448b8f8f333f556486a3/2.5.2.2_b-46-hero_woman-min.png" alt="First PREMIER Bank">
                            <h2>Deposit Checks Remotely, without Leaving the Office</h2>
            <p>Remote Deposit is a safe, secure and efficient way to process checks received at your place of business, without running to the bank.</p>
                ...
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="../../../../contentassets/1c53b2282f564c9db79b0163456e8c1a/2.2.3_b-16-list_01_alternating-2_scanner-min.png" title="Step 1: Scan" alt="credit card reader"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>Step 1: Scan</h2>

                                <div class="xhtml"><p>Using the desktop check scanner we provide, you can quickly scan both sides of checks in a single pass. We accommodate highly accurate batch scans and allow you to view images of scanned checks right from your computer.</p></div>
                ...
                <div class="container">
                    <div class="b16basic_box">
                        <div class="b16basic_box_right">
                            <div class="b16imgcrop" style="margin-left:90px;"><img src="../../../../contentassets/1d255fccc6644645a20d5109fa31972c/2.5.2.2_b-16-list01_alternating-2_transmit-min.png" title="Step 2: Transmit" alt="women looking at laptop"></div>

                        </div>
                        <div class="b16basic_box_left payIcon-space">
                            <h2 style="padding-top:0px !important;">Step 2: Transmit</h2>
                                <div class="xhtml"><p>Your scanned check amounts are automatically read and deposits are totaled for you on the spot. When you're ready to make a deposit, follow our simple instructions to transmit from your computer! You can make your deposit any time, day or night, through a secure Internet connection.</p></div>
        ...
        <div class="b16basic_box_left_content b16basic_box_background">
            <div class="b16basic_box_main">
                <div class="container">
                    <div class="b16basic_box b16basic_box_position">
                        <div class="b16basic_box_right" style="padding-right:50px;">
                            <div class="b16imgcrop"><img src="../../../../contentassets/194e4258f80142fbb446b8a6812e5acb/2.5.2.2_b-16-list01_alternating-3_deposit-min.png" title="Step 3: Deposit" alt="woman smiling"></div>
                        </div>
                        <div class="b16basic_box_left">
                                <h2>Step 3: Deposit</h2>

                                <div class="xhtml"><p>First PREMIER Bank receives and processes your check images quickly and efficiently, applying later deposit deadlines so your funds become available faster. Payments received by 6pm Central Time are deposited same-day. Payments received after 6pm will be deposited the next business day.</p></div>
                            <!-- Button and Footer Links go here ... -->
                            <!-- Button and Footer Links go here ... -->
                        </div>
                    </div>
...
<section class="row-full b17promo">
    ...
    <div class="b17free_mobile_banking ">
        <div class="container">
            <h2>The Benefits of Remote Deposit</h2>

            <div class="b17free_mobile_banking_right">
                                <div class="xhtml"><ul>
<li>Perfect for high volume / high dollar deposits</li>
<li>Easy-to-use scanner and software</li>
<li>Secure and automated system</li>
<li>Time-saving, accurate and efficient way to deposit funds</li>
<li>Process large volumes of checks easily</li>
<li>No manual preparation of deposits</li>
<li>No need for trips to the bank</li>
<li>Fast funds deposit improves cashflow</li>
</ul></div>
                <div class="b17PayLinks payIcon-space">
                </div>

                <!-- Button and Footer Links go here ... -->
                                <a href="../../../pages/about-us/teams/small-business-banking-team/index.html" class="b17readmore">Contact Us</a>
            </div>

                <div class="b17free_mobile_banking_left right">
                    <img class="img-responsive" id="imgMainImage" style="border-radius:50%" src="../../../../contentassets/28e6a004052e448abe820dcf7c3fbb81/2.5.2.2_b-17-promo_group-min.png" alt="First PREMIER Bank">
                </div>
        </div>
    </div>


    <div id="a41779099" class="modal fade" role="dialog">
...
<section class="row-full">
        ...
        <div class="b25need_help_main">
            <div class="container">
                ...
                <div class="xhtml"><p>Whether you&rsquo;re new to First PREMIER Bank or an existing business banking customer, we&rsquo;d be happy to discuss pricing and help you get started. Contact a business banker today.</p></div>

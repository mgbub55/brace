...
<li><a href="../business-debit-mastercard/index.html">Debit Mastercard<strong style="color: #222222; font-family: Roboto, arial, sans-serif; font-size: 16px;">&reg;</strong></a>&nbsp;with built-in fraud protection</li>
...
<li>Available <a title="overdraft protection" href="../overdraft-protection/index.html">overdraft protection</a></li>
</ul></div>
...
<p>&nbsp;</p>
<ul>
<li>Manage account via <a title="Online &amp; Mobile Banking" href="../../online-and-mobile/index.html">Online and Mobile Banking</a></li>
...
<p>{3} A $5 monthly paper statement fee is assessed to customers receving paper statements</p>
<p>{4} &ldquo;Transaction&rdquo; refers to any combination of items, paid or unpaid, including paper and electronic. 150 free total transactions represents a combination of withdrawals and deposits before withdrawal and deposit fees apply. First PREMIER will assess a cost-per-excess transaction fee over transactions allowed per statement cycle. Withdrawals do not include transactions made using a First PREMIER Bank Business Debit Card, transactions initiated through wire transfer, transactions initiated through online bill payment, or transfers initiated through Business Online Banking. Deposits do not include transactions made at an ATM, through Mobile Deposit, or transfers made through Business Online Banking.<br /><br /><br /></p>
                </div>
            </div>
        </div>

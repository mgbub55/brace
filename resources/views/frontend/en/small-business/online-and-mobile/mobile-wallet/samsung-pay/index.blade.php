            ...
            <div class="block b46block  col-md-12">
                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            <h1>Samsung Pay*</h1>
                            <img src="{{asset('assets/frontend/contentassets/dfb010e86df24fad9386c2c98d55f785/1.2.4.3_b-46-subpage-hero-01-benefits_womanstreet-min.png')}}"
                                alt="First PREMIER Bank">
                            <h2>For Samsung Galaxy Phones &amp; Gear Smart Watches</h2>
                            <p>Pay almost anywhere in the world quickly and easily with Samsung Pay. We&rsquo;ll help you
                                get started with our step-by-step instructions below.&nbsp;</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{asset('assets/frontend/contentassets/bf5ab7b361794abfb4706fb5219f68f3/1.2.4.3_b-16-list-01-alternating-1_handphone-min.png')}}"
                                                title="STEP 1: Phone, Tablet or Gear" alt="cell phone"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>STEP 1: Phone, Tablet or Gear</h2>

                                        <div class="xhtml">
                                            <p>For Samsung Galaxy S9, Note8, Galaxy S8 &amp; S8+, Galaxy S7 &amp; S7 edge,
                                                Galaxy S6, Galaxy S6 edge+ &amp; S6 active, Galaxy Note5, Gear S2 (with NFC
                                                only) &amp; Gear S3&nbsp;<br /><br /></p>
                                            <ul>
                                                <li>Find the app pre-installed on your phone OR download
                                                    it<sup>1</sup>&nbsp;</li>
                                                <li>Log in to the app</li>
                                                <li>Scan your fingerprint or iris&nbsp;</li>
                                                <li>Enter a pin to authenticate future purchases</li>
                                                <li>Touch &ldquo;Turn On&rdquo; to set up a secure screen lock if you don't
                                                    already have one set</li>
                                                <li>Touch&nbsp; &ldquo;Add a credit or debit card&rdquo; to enter your First
                                                    PREMIER Bank Debit Mastercard&reg;</li>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="{{asset('assets/frontend/contentassets/f31e2880fc39474cad7570320d852457/1.2.4.2_b-16-list-01-alternating-2_womanwatch-min-left-1.png')}}"
                                                title="STEP 1: Smart Watch" alt="woman using smart watch"></div>
                        ...
                        <div class="b16basic_box_main">
                            <div class="container">
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{asset('assets/frontend/contentassets/80b6526b68f54401a9d31aea03fe8565/1.2.4.3_b-16-list-01-alternating-3_cardphone-min1.png')}}"
                                                title="STEP 2: Add Cards" alt="woman on cell phone"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        ...
                                        <div class="xhtml">
                                            <ul>
                                                <li>Use your device&rsquo;s camera to capture your card info OR enter it
                                                    manually yourself by typing it in<sup>2</sup>&nbsp;</li>
                                                <li>If you&rsquo;re asked to verify your payment method, choose a
                                                    verification method from the list</li>
                                                <li>Find and enter the verification code when you receive one</li>
                                                <li>NOTE:&nbsp; A method of payment (credit or debit card) must be added to
                                                    your Gear S3 separately, even if you have already added one or more to
                                                    the Samsung Pay app</li>
                    ...
                    <div class="b18great_feature_main">
                        ...
                        <div class="b18great_feature_left">
                            ...
                            <div class="b18detail xhtml">
                                <p>Samsung Pay works at millions of places around the world. Visit the list of merchants on
                                    the Samsung Pay site.&nbsp; Samsung Pay works with NFC, magnetic stripe and EMV
                                    (Europay, Mastercard and Visa) terminals for chip-based cards.</p>
                                ...
                                <ul>
                                    ...
                                    <li>Each transaction is authenticated by your fingerprint, pin number or retina scan.
                                    </li>
                                    <li>Should you lose your phone, just use the Find My Mobile service to remove all cards
                                        from your handset. There is no need to cancel your credit cards.</li>
                                    <li>Enjoy Zero Liability&reg; Protection for all First PREMIER Bank Debit
                                        Mastercard&reg; purchases</li>
                                </ul>
                                <p>&nbsp;</p>
                            </div>
                        </div>
                        <div class="b18great_feature_left b18great_feature_right payIcon-space">
                            ...
                            <div class="b18detail xhtml">
                                <ul>
                                    ...
                                    <li>Verify the payment by holding your finger on the home button fingerprint sensor or
                                        enter your PIN&nbsp;&nbsp;</li>
                                    <li>Place the back of your device on the card reader</li>
                                    <li>When the payment goes through, you&rsquo;ll get a notification confirming the
                                        merchant and the purchase amount, which is also documented in the Samsung Pay app
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <section class="row-full">
                    ...
                    <div class="b25need_help_main">
                        <div class="container">
                            ...
                            <div class="xhtml">
                                <p style="text-align: center;">If you have any questions on Samsung Pay, please contact our
                                    Customer Care Center at 800-501-6535.</p>
                            </div>
                            <div class="b25bottom" style="">
                                <center>
                                    <a href="{{ route('frontend.en.pages.quick-links.customer-care') }}"
                    ...
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <div class="b13points">
                                ...
                                <p>{2} Samsung Pay does not have the option to set a default card. When you open Samsung
                                    Pay, the most recently used, viewed, or added card will display.</p>
                                <p>{3} Samsung pay works with almost all point-of-sale systems: NFC, magnetic stripe and EMV
                                    (Europay, Mastercard and Visa) terminals for chip-based cards.</p>

            ...
            <div class="block b46block  col-md-12">
                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            <h1>Google Pay*</h1>
                            <img src="{{asset('assets/frontend/contentassets/279e48c87c654f85a9e24f5d7334be1d/1.2.4.2_b-46-subpage-hero-01-benefits_womanstreet-min.png')}}"
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{asset('assets/frontend/contentassets/7b1d2c3d192f4fdd9623b8752d12fe36/1.2.4.2_b-16-list-01-alternating-1_guytablet.png')}}"
                                                title="STEP 1: Phone or Tablet" alt="man on cell phone"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>STEP 1: Phone or Tablet</h2>

                                        <div class="xhtml">
                                            <p>For Android Phones &amp; Tablets:<br /><br /></p>
                                            <ul>
                                                <li><a
                                                        href="https://play.google.com/store/apps/details?id=com.google.android.apps.walletnfcrel">Download
                                                        and/or open</a> the Google Pay app<sup>1</sup></li>
                                                <li>Configure the app by following instructions provided</li>
                                                <li>NOTE:&nbsp; A lock screen is required to make secure payments&nbsp;
                                                    <ul>
                                                        <li>If you don&rsquo;t use a lock screen already, open
                                                            &ldquo;Settings&rdquo; tap &ldquo;Security&rdquo; and then tap
                                                            &ldquo;Screen lock&rdquo; and set up your preferred unlock
                                                            method:&nbsp; PIN, pattern, password, or fingerprint.</li>
                                                        <li>Google Pay does not work with screen locks like Smart Unlock,
                                                            Knock to Unlock, or retina scanning</li>
                                                    </ul>
                                                </li>
                                                <li>To make purchase in-store, make sure your Android device has NFC
                                                    (near-field communication) enabled. For instructions on turning on NFC,
                                                    please visit: <a title="Google"
                                                        href="https://support.google.com/pay/answer/7385877" target="_blank"
                                                        rel="noopener">https://support.google.com/pay/answer/7385877</a>
                                                </li>
                                                <li>GO TO STEP 2&nbsp;</li>
                                            </ul>
                                        </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="{{asset('assets/frontend/contentassets/d9b586d092c8428cb7f2b708022f1ed2/1.2.4.2_b-16-list-01-alternating-2_womanwatch-min-left.png')}}"
                        ...
                        <div class="b16basic_box_main">
                            <div class="container">
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="{{asset('assets/frontend/contentassets/721169a6eb76425d989d6d038db0f813/1.2.4.2_b-16-list-01-alternating-3_phone-min1.png')}}"
                                    ...
                                    <div class="b16basic_box_left">
                                        ...
                                        <div class="xhtml">
                                            <ul>
                                                ...
                                                <li>Use the camera on your phone to capture your First PREMIER Bank Debit
                                                    Mastercard&reg;&nbsp;information OR enter it manually by typing in the
                                                    number.<sup>2</sup></li>
                                                <li>Repeat for other cards as necessary</li>
                                                <li>Make your First PREMIER debit your default card by tapping
                                                    &ldquo;Cards&rdquo; on the lower right</li>
                    ...
                    <div class="b18great_feature_main">
                        ...
                        <div class="b18great_feature_left">
                            ...
                            <div class="b18detail xhtml">
                                <p>Google Pay works at millions of places around the world. Use it anywhere contactless
                                    payments are accepted. Visit the list of merchants on the <a
                                        href="https://pay.google.com/about/where-to-use/">Google Pay</a> site.</p>
                                ...
                                <ul>
                                    ...
                                    <li>Enjoy Zero Liability&reg; Protection for all First PREMIER Bank Debit Mastercard
                                        purchases</li>
                                </ul>
                                <p>&nbsp;</p>
                            </div>
                        ...
                        <div class="b18great_feature_left b18great_feature_right payIcon-space">
                            ...
                            <div class="b18detail xhtml">
                                <p>Your debit and credit card information is stored on your device so when you are ready to
                                    complete the transaction in a store, simply unlock your phone and hold your device
                                    against the card terminal for a few seconds until you see a green check mark.
                                    You&rsquo;re done!</p>
                            </div>
                        </div>
                        <div class="clearfix">
                ...
                <section class="row-full">
                    ...
                    <div class="b25need_help_main">
                        <div class="container">
                            ...
                            <div class="xhtml">
                                <p style="text-align: center;">For questions about Google Pay, please contact our Customer
                    ...
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <div class="b13points">
                                ...
                                <p>{2} If you are asked to verify your payment method, choose a verification method from the
                                    list provided and follow the instructions to verify. (E.g. text a verification code,
                                    call me with verification code).</p>

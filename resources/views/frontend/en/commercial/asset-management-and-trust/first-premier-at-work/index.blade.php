                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="../../../../contentassets/28e8e5119fb14759b9396cf925d1273f/2.7.4_b-46-hero_meeting-min.png"
                                alt="First PREMIER Bank">
                            <h2>Unique Privileges for Employees</h2>
                            <p>Extend essential financial resources to your employees with a customized banking, finance and
                                educational support program from First PREMIER Bank.</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../contentassets/88bc37ccb9bf4fd3855243447e22b692/2.7.4_b-16-list-01-alternating-1_employees-min.png"
                                                title="First PREMIER Bank, a Partner for Business"
                                                alt="man and woman smiling"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>First PREMIER Bank, a Partner for Business</h2>

                                        <div class="xhtml">
                                            <p>The financial health of employees impacts the financial position of an
                                                organization. That&rsquo;s why First PREMIER helps business banking clients
                                                develop customized First PREMIER at Work programs that benefit employees.
                                                Our programs combine banking and financial services with customized
                                                educational offerings (saving for retirement, debt reduction seminars, etc.)
                                                to support employee financial health. We&rsquo;ll design a program that
                                                meets the unique needs of your team, assigning a dedicated banker to support
                                                the ongoing needs for the future.</p>
                                        </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="../../../../contentassets/534e08b98e20456ca2517032c0c75a8c/2.7.4_b-16-list-01-alternating-2_employees2-min.png"
                                                title="Program Benefits" alt="two women looking at laptop smiling"></div>
                                    ...
                                    <div class="b16basic_box_left payIcon-space">
                                        ...
                                        <div class="xhtml">
                                            <ul>
                                                ...
                                                <li>Motivate employee participation in direct deposit, retirement plans,
                                                    etc.</li>
                ...
                <section class="row-full">
                    ...
                    <div class="b25need_help_main">
                        <div class="container">
                            ...
                            <div class="xhtml">
                                <p>Find out how a First PREMIER at Work program can work for you.</p>
                                <p>Speak to a Business Banker today.</p>
                            </div>
                    ...
                    <div class="b17free_mobile_banking ">
                        <div class="container">
                            ...
                            <div class="b17free_mobile_banking_right">
                                ...
                                <div class="xhtml">
                                    <p>From 401(k), IRA, stock purchase and profit sharing plans, we can help establish
                                        meaningful employment incentives that help foster loyalty, support retention and
                                        build a brighter future for your best assets: the people who work for you.</p>
                                </div>
                            ...
                            <div class="b17free_mobile_banking_left right">
                                <img class="img-responsive" id="imgMainImage" style="border-radius:50%"
                                    src="../../../../contentassets/3bf4317feff843718ca374ac11920848/2.7.4_b-17_manpapers-min.png"
                                    alt="First PREMIER Bank">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="b15benfits_main_box b17cards">
                        <div class="container">
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="../../../../globalassets/images/secondary-icons/blue/places/blue-places-secondary-icon-5.png"
                                        title="Group Retirement Plans" alt="man looking at report smiling" width="116px"
                                        height="116px">
                                </div>
                                <div class="b15avtar_content">
                                    <h3>Group Retirement Plans</h3>
                                    <p>Find out how First PREMIER Bank can help you establish and administer a retirement
                                        plan for your business.</p>
                                    <div class="clearfix"></div><br />
                                    <a
                                        href="../../../small-business/asset-management-and-trust/group-retirement-plans/index.html">Learn
                                        More</a>
                                </div>
                            </div>
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="../../../../globalassets/images/secondary-icons/bright/business-finance/bright-business-_-finance-secondary-icon-11.png"
                                        title="Asset Management" alt="man looking at report smiling" width="116px"
                                        height="116px">
                                </div>
                                <div class="b15avtar_content">
                                    <h3>Asset Management</h3>
                                    <p>Learn how First PREMIER Bank supports financial planning and comprehensive asset
                                        management.</p>
                                    <div class="clearfix"></div><br />
                                    <a href="../../../small-business/asset-management-and-trust/index.html">Learn More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left:40px;">
                                                        ...
                                                        <div class="b46Blue" style="text-align:left;">
                                                            ...
                                                            <p><br /><a
                                                                    href="../../../small-business/asset-management-and-trust/employee-benefits/index.html"
                                                                    target="_blank"></a></p>
                                                        </div>
                                                    </div>
                                                </div>

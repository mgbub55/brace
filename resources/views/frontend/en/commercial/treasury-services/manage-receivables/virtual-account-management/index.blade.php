                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="../../../../../contentassets/57d88d6dcf0c449ca879fd3350ebbe0f/3.4.2.2_b-46_hero_team-min.png"
                                alt="First PREMIER Bank">
                            <h2>Streamline Account Management &amp; Reduce Overhead</h2>
                            <p>First PREMIER Bank's Virtual Account Management solution streamlines account management,
                                reduce costs and optimize working capital.</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/048322bba0db41039cb4b217abbd7a2f/3.4.2.2_b-16-list01_alternating-1_men-min.png"
                                                title="The Basics" alt="two business men looking over reports"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>The Basics</h2>

                                        <div class="xhtml">
                                            <p>Virtual Accounts are a cost-effective means of centralizing and
                                                streamlining account management, eliminating the need for a complex and
                                                costly network of physical accounts. Virtual accounts are non-physical
                                                accounts that are created and tied directly to a physical account at
                                                First PREMIER Bank. Virtual accounts carry a unique account number and
                                                online access, which can be used to simpllify account reconcilation,
                                                billing and payment collection. Funds movement takes place through the
                                                linked physical account, while reporting can be done at both the virtual
                                                and physical account level.</p>
                                        </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="../../../../../contentassets/31613f91dfd3462d8cfb63de9645483d/3.4.2.2_b-16-list01_alternating-2_circle-min.png"
                                                title="For Companies with:"
                                                alt="people sitting around conference table"></div>

                                    </div>
                                    <div class="b16basic_box_left payIcon-space">
                                        <h2 style="padding-top:0px !important;">For Companies with:</h2>
                                        <div class="xhtml">
                                            <ul>
                                                <li>Complex banking and treasury services needs</li>
                                                <li>Large transaction or deposit volume</li>
                                                <li>Complicated infrastructure, multiple locations or geographics</li>
                                                <li>Multiple customer accounts with unique treasury services needs</li>
                                                <li>Supplier, vendor or client accounts with ongoing transactions</li>
                                                <li>A desire for more centralized account access and control and
                                                    increased transparency into working capital positions</li>
                                            </ul>
                                        </div>
                        ...
                        <div class="b16basic_box_main">
                            <div class="container">
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/ed17a693dd5f47ceb26ceda6897d7601/3.4.2.2_b-16-list01_alternating-3_lady-min.png"
                                                title="The Benefits" alt="business woman"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>The Benefits</h2>
                                        ...
                                        <div class="xhtml">
                                            <ul>
                                                <li>Set up custom virtual account structures based on business needs
                                                </li>
                                                <li>Streamline and centralize account and treasury services activities
                                                </li>
                                                <li>Eliminate the need for an extensive network of physical accounts
                                                </li>
                                                <li>Reduce costs associated with multiple physical accounts&nbsp;</li>
                                                <li>Simplify cash management and account reconciliation</li>
                                                <li>Optimize working capital management</li>
                                                <li>Easy online account access and administration</li>
                                            </ul>
                                        </div>
                                        <!-- Button and Footer Links go here ... -->
                                        <!-- Button and Footer Links go here ... -->

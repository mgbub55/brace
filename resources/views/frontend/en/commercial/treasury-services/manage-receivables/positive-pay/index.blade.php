...
@section('content')
    <div class="container">
        ...
        <div class="row equal-height">
            <div class="block b46block  col-md-12">
                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            <h1>Positive Pay</h1>
                            <img src="../../../../../contentassets/76399f9d75924b45a795f3484e438e92/3.4.2.7_b-46-hero_seriousexecutive-min.png"
                                alt="First PREMIER Bank">
                            <h2>Powerful Fraud Protection for Business</h2>
                            <p>Financial losses from check or ACH fraud can be costly and impact your business. Catch
                                problems early with Positive Pay.</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/3fc6b3aea2724deb9a98c1e5548ce8c2/2.1.7.3_b-16-list01_alternating-1_check-min.png"
                                                title="Features" alt="hand writing check"></div>
                                    </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="../../../../../contentassets/54057db204474fc1a4a8605ced7796bd/2.1.7.3_b-16-list01_alternating-2_woman-min.png"
                                                title="Additional Benefits" alt="woman on tablet"></div>
            ...
            <div class="block b55block  col-md-12">
                <center>
                    <div class="b55main">
                        <h2>Positive Pay Demo</h2>
                        <a href="https://www.onlinebanktours.com/mobile/?b=1490&amp;c=45137"><img
                                src="../../../../../Static/img/smbvideo.png" border="0"></a>
                    </div>
                </center>
            </div>
                ...
                <section class="row-full">
                    ...
                    <div class="b25need_help_main">
                        <div class="container">
                            ...
                            <div class="xhtml">
                                <p>For security reasons, Positive Pay enrollment is not available online. To sign up for
                                    Positive Pay, please contact a business banker or visit your nearest branch. We will
                ...
                <section class="row-full">
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <h4> Disclosure </h4>
                            <div class="b13points">
                                <p>{1} There is a $0.05 per item fee for the Payee Match service. Service Fees shall be
                                    assessed on a monthly basis from Company's Account.</p>
                            </div>
                        </div>
                    </div>
                </section>

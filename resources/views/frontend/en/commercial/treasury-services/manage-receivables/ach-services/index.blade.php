            ...
            <div class="block b46block  col-md-12">
                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            <h1>ACH Services</h1>
                            <img src="../../../../../contentassets/90c0ed6661f248e692fffa29a659b289/3.4.2.1_b-46_hero_team-min.png"
                                alt="First PREMIER Bank">
                            <h2>The 14th Largest ACH Originating Bank in the Nation</h2>
                            <p>Financial strength. Proven reliability. Personal, responsive service. First PREMIER Bank is a
                                forerunner in electronic payments. We work with businesses, payroll and payment processors
                                of all sizes, providing reliable service and exceptional customer service.</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/6cfa907eb62842aaad3f9478afbd5ca0/3.4.2.1_b-16-alt1_team-min.png"
                                                title="Manage Payables Efficiently"
                                                alt="construction workers looking at tablet"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        ...
                                        <div class="xhtml">
                                            <ul>
                                                <li>Schedule and manage outbound customer, vendor and tax payments</li>
                                                <li>Set up and schedule recurring payments</li>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="../../../../../contentassets/c9e9973a1c2d4368841bd895d05283b2/3.4.2.1_b-16-alt2_man-min.png"
                                                title="Payment Processing" alt="business men shaking hands"></div>

                                    </div>
                                    <div class="b16basic_box_left payIcon-space">
                                        <h2 style="padding-top:0px !important;">Payment Processing</h2>
                                        <div class="xhtml">
                                            <p>We provide robust payment processing solutions for large-scale payroll
                                                services providers.</p>
                                            <ul>
                                                <li>Simplify payroll and expense reimbursement</li>
                                                <li>Pay employees quickly and predictably</li>
                                                <li>Provide direct deposit services for employees and vendors</li>
                                                <li>Decrease overhead and costs by moving to electronic payment</li>
                                                <li>Control disbursements to maintain cash control</li>
                                            </ul>
                                        </div>
                        ...
                        <div class="b16basic_box_main">
                            <div class="container">
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/52bbab4cbeb84781879ef22f47fcde4d/3.4.2.1_b-16-alt3_smile-min.png"
                                                title="Manage Accounts Receivable" alt="woman smiling"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>Manage Accounts Receivable</h2>
                                        ...
                                        <div class="xhtml">
                                            <ul>
                                                ...
                                                <li>Lower costs, risks and overhead</li>
                                            </ul>
                                        </div>
                                        <!-- Button and Footer Links go here ... -->
                                        <!-- Button and Footer Links go here ... -->
                ...
                <section class="row-full">
                    ...
                    <div class="b25need_help_main">
                        <div class="container">
                            ...
                            <div class="xhtml">
                                <p>We have the know-how, technology and Treasury Specialists to help you manage and optimize
                                    your cash management. Contact our Treasury Services team today.</p>
                            </div>
                                    ...
                                    <div class="item active">
                                        <div class="row b6mypadding">
                                            <div class="b6featured_quote_img col-lg-5 col-md-5"><img
                                                    src=../../../../../contentassets/cdd13c2052384d8b96c9eae61e81775b/quotes-dennisfeterl.png
                                                    class="b6featured_img" alt="Dennis Feterl VP Treasury Services"></div>
                                            <div class="b6featured_quote col-lg-7 col-md-7">
                                                <p>We stand out from the rest because of our strength and service. At First
                                                    PREMIER, you aren’t dealing with a team of 200. You’re dealing with one
                                                    of America’s strongest banks and a handful of dedicated specialists
                                                    ready to address your needs.</p>
                                                <div class="clearfix"></div><span> - Dennis J. Feterl, VP, Treasury
                                                    Services</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="row b6mypadding">
                                            <div class="b6featured_quote_img col-lg-5 col-md-5"><img
                                                    ...
                                                    class="b6featured_img" alt="Mike Kaiser VP Treasury Services"></div>
                                            <div class="b6featured_quote col-lg-7 col-md-7">
                                                <p>Our innovative systems, processes and technology are proven and reliable.
                                                    We constantly go above and beyond to provide excellent service. Our
                                                    clients are always given a dedicated line of communication to our team.
                                                </p>

                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="../../../../../contentassets/4b5c5dd65a7746c0940ed6b0b21e1639/2.5.4_b-46-hero_creditcard-min.png"
                                alt="First PREMIER Bank">
                            <h2>Accept Debit &amp; Credit Cards</h2>
                            <p>Streamline checkout and boost revenue with our turnkey Merchant Card Solutions through
                                Elavon<sup>1</sup>, serving more than 1 billion businesses worldwide.</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/9754a2dc9d734954a9b209c28a72db58/2.5.4_b-16-list01_alternating-1_customer-min.png"
                                                title="Make it Easier for Customers to Pay"
                                                alt="mother holding child who is handing clerk credit card"></div>
                                    </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="../../../../../contentassets/65b4b8af06194eaa8abe726cdbed0a55/2.5.4_b-16-list01_alternating-2_guy-min.png"
                                                title="Improve Productivity, Increase Revenue" alt="man looking at laptop">
                                        </div>
                        ...
                        <div class="b16basic_box_main">
                            <div class="container">
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/2b4ddc36bfd042f6905f88332e3b9521/2.5.4_b-16-list01_alternating-3_woman-min.png"
                                                title="Safe, Secure Payment" alt="woman smiling"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                ...
                <section class="row-full">
                    ...
                    <div class="b25need_help_main">
                        <div class="container">
                            ...
                            <div class="xhtml">
                                <p>We excel in helping small businesses do the heavy lifting. Contact a business banker to
                                    find out how First PREMIER Bank Business Services can help your business grow.</p>
                            </div>
                ...
                <section class="row-full">
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <h4> Disclosures </h4>
                            <div class="b13points">
                                <p>{1}&nbsp;First PREMIER Bank Merchant Card Services are offered in alliance with
                                    Elavon.&nbsp;</p>
                                <p>{2} Elavon offers built-in fraud monitoring and control features to protect business and
                                    customer card data. PCI Compliance program leverages education, card and data validation
                                    and financial protection programs to&nbsp; protect cardholder data to ensure compliance.
                                </p>
                            </div>
                        </div>
                    </div>

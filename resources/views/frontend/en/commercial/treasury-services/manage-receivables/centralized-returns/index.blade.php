            ...
            <div class="block b46block  col-md-12">
                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            <h1>Centralized Returns Processing</h1>
                            <img src="../../../../../contentassets/ab054c5ecd8e4aa79f47c20db3e23895/3.4.2.6_b-46-hero_storeage-min.png"
                                alt="First PREMIER Bank">
                            <h2>Consolidate Returns for Faster Processing</h2>
                            <p>Streamline the processing of returned items to create new operating efficiencies.</p>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="../../../../../contentassets/d33faf6c35224bce855640002219ad6c/3.4.2.6_b-16--alt1_hands-min.png"
                                                title="The Basics" alt="woman&#39;s hands using mobile phone"></div>

                                    </div>
                                    <div class="b16basic_box_left payIcon-space">
                                        <h2 style="padding-top:0px !important;">The Basics</h2>
                                        <div class="xhtml">
                                            <p>Managing returns and rerouting for payment is an arduous and costly
                                                process. First PREMIER Bank enables companies with multiple banking
                                                relationships to consolidate check returns to a single bank. This
                                                streamlines the returns process, and can result in an improved potential
                                                rate of collection on returned items. It also reduces routing delays,
                                                returned check fees and administrative overhead.</p>
                                        </div>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/e194c416993e4a479e02469c6658b68a/3.4.2.6_b-16--alt2_man-min.png"
                                                title="The Benefits" alt="man using tablet smiling"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        ...
                                        <div class="xhtml">
                                            <ul>
                                                <li>Consolidate unpaid and returned checks to one bank</li>
                                                <li>Great for companies without collections expertise</li>
                                                <li>Perfect for companies with multiple banking relationships</li>
                                                <li>Reduce routing delays and returned check fees</li>
                                                <li>Improve payment and collections efficiency</li>
                                                <li>Improve funds availability</li>
                                                <li>Potential increased rate of collection on returned items</li>
                                            </ul>
                                        </div>
                                        <!-- Button and Footer Links go here ... -->
                                        <!-- Button and Footer Links go here ... -->
                    ...
                    <div class="b25need_help_main">
                        <div class="container">
                            ...
                            <div class="b25bottom" style="">
                                <center>
                                    <a href="../../index.html" class="b25mainanchor">CONTACT US</a><br clear="all" />
                                </center>
                            </div>
                        </div>
                    </div>

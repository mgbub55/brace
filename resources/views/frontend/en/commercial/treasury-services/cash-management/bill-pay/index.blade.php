            ...
            <div class="block b46block  col-md-12">
                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            <h1>Bill Pay</h1>
                            <img src="../../../../../contentassets/073745182f944c98972dd2680487ab03/2.2.3_b46-hero_trucker-min.png"
                                alt="First PREMIER Bank">
                            <h2>Freedom from Stamps, Envelopes &amp; Paper Checks</h2>
                            <p>Make on-demand and scheduled payments quickly and easily, managing bill payments from one,
                                central location.</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/b1d520c6da144ca1af241c5433adb479/2.2.3_b16_alternate-1_feature-right.png"
                                                title="Features" alt="woman on tablet"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        ...
                                        <div class="xhtml">
                                            <ul>
                                                <li>FREE feature of <a title="Online Banking"
                                                        href="../../../../small-business/online-and-mobile/online-banking/index.html">Online
                                                        Banking</a> and <a title="Mobile Banking App"
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="../../../../../contentassets/843874b0a22f404eb74d1aa706114749/2.2.3_b-17_promo_woman-left.png"
                                                title="Benefits" alt="woman on laptop"></div>
                        ...
                        <div class="b16basic_box_main">
                            <div class="container">
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/fd923b3862f64c8bab11c30b48440be8/2.2.3_b16_alternate-3_admin-min.png"
                                                title="Easy Administration" alt="two women looking at laptop"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                        ...
                        <div class="container">
                            ...
                            <div class="xhtml">
                                <p>Whether you&rsquo;re starting from scratch or transferring your account, our business
                                    bankers can help you get started with the financial management tools to meet your needs.
                                </p>
                            </div>
                        ...
                        <div class="container">
                            ...
                            <div class="b17free_mobile_banking_left right">
                                <img class="img-responsive" id="imgMainImage" style="border-radius:50%"
                                    src="../../../../../contentassets/4ed2542d2ff44274b67b95ada975d882/2.2.3_b-16-list_01_alternating-2_scanner-min.png"
                                    alt="First PREMIER Bank">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="b15benfits_main_box b17cards">
                        <div class="container">
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="../../../../../globalassets/images/secondary-icons/blue/hardware/blue-hardware-secondary-icon-11.png"
                                        title="Business Online Banking" alt="credit card reader" width="116px"
                                        height="116px">
                                </div>
                                <div class="b15avtar_content">
                                    <h3>Business Online Banking</h3>
                                    <p>FREE 24/7 online and mobile account access with eStatements, Bill Pay, Mobile Deposit
                                        and more.</p>
                            ...
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="../../../../../globalassets/images/secondary-icons/bright/edition/bright-edition-secondary-icon-15.png"
                                        title="Security &amp; Fraud Protection" alt="credit card reader" width="116px"
                                        height="116px">
                                </div>
                                <div class="b15avtar_content">
                                    <h3>Security &amp; Fraud Protection</h3>
                                    <p>Find out how First PREMIER Bank helps protect you against fraud and how to protect
                                        ...
                                        <div class="carousel-inner">
                                            <div class='item active'>
                                                ...
                                                <div
                                                    ...
                                                    <div class='b26line_credit_loans_left'><img
                                                            src='../../../../../globalassets/ymabii/commercial/b-17-promo-01-manage-payments.png'
                                                            alt=''></div>
                                                    <div class='b26line_credit_loans_right'>
                                                        <div class="b26titlerow">
                                                            <h3 class='deckspanNoCaret'>Manage Payments</h3>
                                                        </div>
                                                        <h3><br clear='all' />
                                                            <div class="xhtml">
                                                                <p>Electronic payments, merchant card services and more.</p>
                                                                <ul>
                                                                    <li><a
                                                                            href="../../manage-receivables/ach-services/index.html">ACH
                                                                            Services</a></li>
                                                                    <li><a
                                                                            href="../../manage-receivables/remote-deposit/index.html">Remote
                                                                            Deposit</a></li>
                                                                    <li><a
                                                                            href="../../manage-receivables/merchant-card-services/index.html">Merchant
                                                                            Card Services</a></li>
                                                                    <li><a href="../../index.html">Treasury Services</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </h3>

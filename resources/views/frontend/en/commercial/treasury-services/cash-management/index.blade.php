                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="../../../../contentassets/8649da909c2d4d0393ea5c1fef293104/3.4.1_b-46-hero_lady-min.png"
                                alt="First PREMIER Bank">
                            <h2>Efficient Funds Management</h2>
                            <p>Manage funds effectively and put surplus balances to work with First PREMIER Bank cash
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../contentassets/5521fad042404cbdb7ff538888e71c69/3.4.1_b-16-list01_alternating-1_hands-min.png"
                                                title="Customized Cash Management Solutions"
                                                alt="hands pointing to graphs on chart"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>Customized Cash Management Solutions</h2>

                                        <div class="xhtml">
                                            <p>We work with businesses of every size to virtually manage cash and
                                                improve liquidity of funds. We start with a detailed account and needs
                                                analysis and develop a customized plan that harnesses our full suite of
                                                solutions to improve cash flow, maximize liquidity and minimize banking
                                                fees.&nbsp;</p>
                                        </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="../../../../contentassets/9da8cc5c09664612b4b9819c63918ac3/3.4.1_b-16-list01_alternating-2_guys-left.png"
                                                title="Virtual Account Management"
                                                alt="two business men looking at computer monitor"></div>
                        ...
                        <div class="b16basic_box_main">
                            <div class="container">
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../contentassets/d252f55589cc4f55a97c07ea2744fade/3.4.1_b-16-list01_alternating-3_phone-min.png"
                                                title="Proactive Fraud Management"
                                                alt="business man on busy street looking at phone"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>Proactive Fraud Management</h2>

                                        <div class="xhtml">
                                            <ul>
                                                <li>Customized risk monitoring</li>
                                                <li>24/7 debit card fraud monitoring</li>
                                                <li>Ability to set ACH blocks</li>
                                                <li>Fraud and risk management tools</li>
                                                <li>Powerful <a title="Positive Pay"
                                                        href="../manage-receivables/positive-pay/index.html">Positive
                                                        Pay</a>&reg; fraud management solution</li>
                                            </ul>
                                        </div>
                                        <!-- Button and Footer Links go here ... -->
            ...
            <div class="block b18block  col-md-12">
                ...
                <section>
                    <div class="b18great_feature_main">
                        <h2> Centralized Access, Administration &amp; Reporting </h2>
                        <div class="b18great_feature_left">
                            <span>24/7 Account Access &amp; Control</span>
                            <div class="b18detail xhtml">
                                <ul>
                                    <li>Customized access to select tools and services</li>
                                    <li>FREE Business <a title="Online Banking"
                                            href="business-online-banking/index.html">Online Banking</a></li>
                                    <li>FREE <a title="Mobile Banking" href="mobile-banking/index.html">Mobile
                                            Banking</a></li>
                                    <li>FREE <a title="Bill Pay" href="bill-pay/index.html">Bill Pay</a> with
                                        centralized payment history</li>
                                    <li>View, print and download <a title="eStatements"
                                            href="estatements/index.html">eStatements</a></li>
                                    <li>View cancelled checks for up-to-36 months&nbsp;</li>
                                    <li>Debit Card lock/unlock for lost and stolen cards</li>
                                    <li>Tiered administrative access to accounts, eStatements and
                                        reporting<br /><br /><br /></li>
                                </ul>
                            </div>
                        </div>
                        <div class="b18great_feature_left b18great_feature_right payIcon-space">
                            <span>Integrated Reporting</span>
                            <div class="b18detail xhtml">
                                <ul>
                                    <li>View, print and download <a title="eStatements"
                                            href="estatements/index.html">eStatements</a></li>
                                    <li>View checks and transaction history for up-to-36 months</li>
                                    <li>View transactions by account, virtual account, card holder and more</li>
                                    <li>Export data to spreadsheets and financial software</li>
                                    <li>Virtual account reporting and analytics</li>
                                    <li>Available custom reporting based on business needs</li>
                                    <li>EDI-enabled transfer of ACH data to enterprise systems</li>
                                </ul>
                        ...
                        <div class="clearfix">
                            <center>
                                <a href="reporting-and-analytics/index.html" class="btnGreen">Learn More</a>
                            </center>
                        </div>

                    </div>
                    <div id="a13795230" class="modal fade" role="dialog">
                                ...
                                <div class="modal-body">
                                    <div class="pop_main_container_board">
                                        ...
                                        <div class="pop_main_container">
                                            <h2>24/7 Account Access &amp; Control</h2>
                    ...
                    <div id="b13795230" class="modal fade" role="dialog">
                        <div class="modal-dialog pop_board">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="pop_main_container_board">
                    ...
                    <div id="c13795230" class="modal fade" role="dialog">
                        <div class="modal-dialog pop_board">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="pop_main_container_board">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left:40px;">
                                                        ...
                                                        <div class="b46Blue" style="text-align:left;">
                                                            ...
                                                            <p><br /><a href="reporting-and-analytics/index.html"
                                                                    target="_blank"></a></p>
                                                        </div>
                                                    </div>
                                                </div>

                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            ...
                            <img src="../../../../../contentassets/a360028d30904051a0bae6adb5b056fe/3.4.1.7_b-46-hero_hallmeeting-min.png"
                                alt="First PREMIER Bank">
                            <h2>Easy-to-Use, Timely &amp; Accurate Reporting</h2>
                            <p>First PREMIER Bank offers a number of solutions that provide a convenient and secure way
                                to access account and transaction details, monitor and reconcile financial activity.</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/9e07384bef5e40c28f36147f031f0c5b/3.4.1.7_b-16-list01_alternating-1_woman-min.png"
                                                title="ACH &amp; Virtual Account Analysis &amp; Reconciliation"
                                                alt="female doctor"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>ACH &amp; Virtual Account Analysis &amp; Reconciliation</h2>

                                        <div class="xhtml">
                                            <ul>
                                                <li>Easy-to-read ACH and Virtual account reporting</li>
                                                <li>Itemizes and summarizes deposit account and transaction activity
                                                </li>
                                                <li>Supports account and transaction reconciliation</li>
                                                <li>Improves operational efficiency&nbsp;</li>
                                                <li>Enables more efficient, strategic resource alignment</li>
                                                <li>Strengthens internal cash control</li>
                                            </ul>
                                        </div>
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="../../../../../contentassets/cfda772cdea541df88d65e5ecb8563f5/3.4.1.7_b-16-list01_alternating-2_comp-left.png"
                                                title="FREE Business Online Banking" alt="woman on computer"></div>

                                    </div>
                                    <div class="b16basic_box_left payIcon-space">
                                        <h2 style="padding-top:0px !important;">FREE Business Online Banking</h2>
                                        <div class="xhtml">
                                            <ul>
                                                <li>Enable and control employee access to statements</li>
                                                <li>Consolidated view of <a title="bill pay"
                                                        href="../bill-pay/index.html">bill payments</a>, wire transfers
                                                    and more</li>
                                                <li>View <a title="eStatements"
                                                        href="../estatements/index.html">eStatements</a> with PDF
                                                    download for up-to-24 months</li>
                                                <li>View check images for up-to-36 months</li>
                                                <li>Download data for use with accounting software</li>
                                                <li>Reduce risk of mail fraud</li>
                                            </ul>
                                        </div>

                                        <!-- Button and Footer Links go here ... -->
                                        <div class="b16confidence_links">
                                            <a href="../business-online-banking/index.html"
                                                class="b16readmore">LEARN MORE</a>
                                            <a class="b16mainlink"
                                                href="../../../../pages/about-us/teams/treasury-services-team/index.html"
                        ...
                        <div class="b16basic_box_main">
                            <div class="container">
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../../contentassets/eb37102cb4fd4d159abc3af066d187b5/3.4.1.7_b-16-list01_alternating-3_men-min.png"
                                                title="Electronic Data Interchange (EDI)"
                                                alt="two business men looking at tablet"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        ...
                                        <div class="xhtml">
                                            <ul>
                                                <li>Integrate financial data with core systems and business intelligence
                                                    tools</li>
                                                <li>Translate ACH data records into meaningful information</li>
                                                <li>Enable transaction information to be leveraged by integrated

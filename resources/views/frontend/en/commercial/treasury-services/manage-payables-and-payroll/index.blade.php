        ...
        <div class="row equal-height">
            <div class="block b46block  col-md-12">
                ...
                <section class="row-full">
                    <div class="b46productpage">
                        <div class="container">
                            <h1>Manage Payables &amp; Payroll</h1>
                            <img src="../../../../contentassets/96130bcb92e64b6584e798ac7be77b5a/3.4.3_b-46_hero_team-min.png"
                                alt="First PREMIER Bank">
                            <h2>Efficient Accounts Payable</h2>
                            <p>First PREMIER bank offers a comprehensive suite of leading-edge tools that streamline the
                                way your company pays vendors, bills, taxes and employees.</p>
                                ...
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../contentassets/2b3b5f5e19064ec0aafd1073cd1efd44/3.4.3_b-16-alt1_man-min.png"
                                                title="ACH Services" alt="business man smiling"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>ACH Services</h2>

                                        <div class="xhtml">
                                            <p>As the 14th largest ACH originating financial institution and one of the
                                                strongest capitalized banks in the nation, First PREMIER Bank is well
                                                suited to help you establish solutions to manage accounts payable and
                                                receivable. Our ACH Services team provides turnkey support for payment
                                                of vendor, tax and payroll processing electronically, via wire transfer,
                                                direct deposit or prepaid card.</p>
                                        </div>
                                        <!-- Button and Footer Links go here ... -->
                                        <a href="../manage-receivables/ach-services/index.html"
                                ...
                                <div class="b16basic_box">
                                    <div class="b16basic_box_right">
                                        <div class="b16imgcrop" style="margin-left:90px;"><img
                                                src="../../../../contentassets/4239ae33ec6544e4a6c0b4b63d4f7da1/3.4.3_b-16-alt2_hands-min.png"
                                                title="Virtual Account Management" alt="two people looking at laptop">
                                        </div>

                                    </div>
                                    <div class="b16basic_box_left payIcon-space">
                                        <h2 style="padding-top:0px !important;">Virtual Account Management</h2>
                                        <div class="xhtml">
                                            <ul>
                                                <li>Perfect for companies with complex cash management needs</li>
                                                <li>Eliminate the need for a complex network of physical accounts</li>
                                                <li>Streamline account management, payments and more</li>
                                                <li>Improve account reconciliation and simplify reporting</li>
                                                <li>Lower overhead and minimize banking fees</li>
                                            </ul>
                                        </div>

                                        <!-- Button and Footer Links go here ... -->
                                        <a href="../manage-receivables/virtual-account-management/index.html"
                                            class="b16readmore">LEARN MORE</a>
                                        <!-- Button and Footer Links go here ... -->
                                    </div>
                                </div>
                        ...
                        <div class="b16basic_box_main">
                            <div class="container">
                                <div class="b16basic_box b16basic_box_position">
                                    <div class="b16basic_box_right" style="padding-right:50px;">
                                        <div class="b16imgcrop"><img
                                                src="../../../../contentassets/85512aeed6324b8f87c0cffedb6ea872/3.4.3_b-16-alt3_team-min.png"
                                                title="Payroll Services" alt="two women looking at laptop"></div>
                                    </div>
                                    <div class="b16basic_box_left">
                                        <h2>Payroll Services</h2>

                                        <div class="xhtml">
                                            <p>We offer ACH payment processing for the nation's leading, large-scale
                                                payment solutions providers, leveraging decades of experience. We are
                                                experts in the mechanics and unique challenges related to managing
                                                payroll transactions, and excel in offering reliable, secure processing.
                                                Our team understands the unique sensitivities involved in managing
                                                payroll, which is why we offer our clients unparalleled personal service
                                                and support.&nbsp;</p>
                                        </div>
                                        <!-- Button and Footer Links go here ... -->
                                        <a href="../index.html" class="b16readmore">Contact Us</a>
                                        <!-- Button and Footer Links go here ... -->
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="item active">
                                        <div class="row b6mypadding">
                                            <div class="b6featured_quote_img col-lg-5 col-md-5"><img
                                                    src=../../../../contentassets/aff9c7485c454640ada3e11dcc91ba61/quotes-mikekaiser.png
                                                    class="b6featured_img" alt="Mike Kaiser VP Treasury Services">
                                            </div>
                                            <div class="b6featured_quote col-lg-7 col-md-7">
                                                <p>Our innovative systems, processes and technology are proven and
                                                    reliable. We constantly go above and beyond to provide excellent
                                                    service. Our clients are always given a dedicated line of
                                                    communication to our team.</p>
            ...
            <div class="block b17block  col-md-12">﻿
                ...
                <section class="row-full b17promo">
                    ...
                    <div class="b17free_mobile_banking ">
                        <div class="container">
                            ...
                            <div class="b17free_mobile_banking_right">
                                <h3>
                                    <p>Business Rewards Mastercard&reg;</p>
                                </h3>
                                <div class="xhtml">
                                    <ul>
                                        <li>Consolidate purchasing power with your organization</li>
                                        <li>Earn 1% cash back for eligible purchases<sup>1</sup></li>
                                        <li>Enjoy purchase insurance, rental car insurance and more<sup>2</sup></li>
                                        <li>Outstanding fraud management solutions</li>
                                        <li>Multi-tiered administrative control</li>
                                    </ul>
                                </div>
                                ...
                                <!-- Button and Footer Links go here ... -->
                                <a href="../../financing/business-debit-mastercard/index.html"
                                    class="b17readmore">LEARN MORE</a>
                            </div>

                            <div class="b17free_mobile_banking_left right">
                                <img class="img-responsive" id="imgMainImage" style="border-radius:50%"
                                    src="../../../../contentassets/da957934c47b4d89b1bfd3d68583c674/3.4.3_b-17_promo_card-min.png"
                                    alt="First PREMIER Bank">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="b15benfits_main_box b17cards">
                        <div class="container">
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="../../../../globalassets/images/secondary-icons/blue/business-finance/blue-business-_-finance-secondary-icon-25.png"
                                        title="Business Debit Mastercard&#174;" alt="woman cashier taking credit card"
                            ...
                            <div class="b15student_parent_main_content b15-bg-student_parent_main_content">
                                <div class="b15avtar">
                                    <img src="../../../../globalassets/images/secondary-icons/gold/hardware/gold-hardware-secondary-icon-11.png"
                                        title="Business Online Banking" alt="woman cashier taking credit card"
                                        width="116px" height="116px">
                                </div>
                                <div class="b15avtar_content">
                                    <h3>Business Online Banking</h3>
                                    <p>Our feature-rich online banking puts you in control with proactive account access
                    ...
                    <div id="a49405884" class="modal fade" role="dialog">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12" style="padding-left:40px;">
                                                        ...
                                                        <div class="b46Blue" style="text-align:left;">
                                                            ...
                                                            <p><br /><a
                                                                    href="../../financing/business-debit-mastercard/index.html"
                                                                    target="_blank"></a></p>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="block b18block  col-md-12">
                ...
                <section>
                        ...
                        <div class="b18great_feature_left">
                            ...
                            <div class="b18detail xhtml">
                                <ul>
                                    ...
                                    <li>14th largest ACH originating bank in the country</li>
                                    ...
                                    <li>12th largest national issuer of Mastercard&reg; Credit Cards</li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div id="a42928963" class="modal fade" role="dialog">
                        <div class="modal-dialog pop_board">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="pop_main_container_board">
                    ...
                    <div id="b42928963" class="modal fade" role="dialog">
                        <div class="modal-dialog pop_board">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="pop_main_container_board">
                    ...
                    <div id="c42928963" class="modal fade" role="dialog">
                        <div class="modal-dialog pop_board">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="pop_main_container_board">
                ...
                <section class="row-full">
                    <div class="b13what_you_know_main">
                        <div class="container" style="background-color:#182e39 !important;">
                            ...
                            <h4> Disclosure </h4>
                            <div class="b13points">
                                <p>{1}&nbsp;See Rewards Program Term for details.</p>
                                <p>{2} Restrictions apply.&nbsp; See Business Credit Card Agreement and Mastercard Guide
                                    to Benefits for details.</p>
                            </div>
                        </div>
                    </div>
                </section>

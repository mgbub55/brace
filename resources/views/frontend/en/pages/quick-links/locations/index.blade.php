...
@section('content')
        ...
        <div class="row equal-height">
                        ...
                        <div class="container">
                            ...
                            <div class="b3premier_family col-md-6">
                                <div class="b3premier_family_left"><img
                                        src="{{ asset('assets/frontend/contentassets/aff3e5b4308f4e5ba50f350765fefbe9/1.8_b-03-premierbank-min.png') }}"
                                        alt="First PREMIER Bank Locations" class="img-responsive"></div>
                                <div class="b3premier_family_right">
                                    <span><a href="first-premier-bank-locations/index.html">First PREMIER Bank
                                            Locations</a></span>
                                    <div class="xhtml"></div>
                                </div>
                            </div>
                            ...
                            <div class="b3premier_family col-md-6">
                                <div class="b3premier_family_left"><img
                                        src="{{ asset('assets/frontend/contentassets/aff3e5b4308f4e5ba50f350765fefbe9/1.8_b-03-premierbankcard-min.png') }}"
                                        alt="PREMIER Bankcard Locations" class="img-responsive"></div>
                                <div class="b3premier_family_right">
                                    <span><a href="premier-bankcard-locations/index.html">PREMIER Bankcard
                                            Locations</a></span>
                                    <div class="xhtml"></div>
                                </div>
                            </div>
            ...
            <div class="block b04block  col-md-12">
                <style>
                    ...
                    .b3premier_family_right {
                        height: 130px;
                    }

                    .b3premier_family_right span>a {
                        position: relative;
                        top: 140px;
                    }
                    ...
                    @media only screen and (max-width:425px) {
                        div.block.b03block.col-md-12 {
                            min-height: 600px;
                            height: 600px;
                        }

                        div.block.b04block.col-md-12 {
                            min-height: 600px;
                            height: 600px;
                            padding-top: 175px;
                        }

                        div.b3premier_family.col-md-6 {
                            min-height: 250px;
                            height: 250px;
                        }
                        ...
                        <div class="b4anywhere_banking" style="width:100%; ">
                            <div class="xhtml">
                                ...
                                <div class="MoneyPass" style="padding-top: 30px !important;">
                                    ...
                                    <div class="logo col-md-3 col-xs-12" style="float: left;">
                                        <center><img class="img-responsive"
                                                src="{{ asset('assets/frontend/contentassets/b4a96dd8c175405cb46d36b342c9a8c0/moneypass_logo.png') }}"
                                                alt="moneypass_logo.png" width="174" height="105" /></center>
                                    </div>
                                    <div class="col-md-5 col-xs-12"
                                        style="float: left; color: #4a6375; font-size: 14px; line-height: 22px; font-family: 'Prompt-Medium'; text-shadow: none;">
                                        <div class="finder">
                                            <center><br />
                                                <form role="search" action="https://www.moneypass.com/atm-locator.html"
                                                    method="get" target="_blank"><input id="atmZipTextId"
                                                        class="input-text input-text-large" name="atmZip" type="text"
                                                        width="200" placeholder="City, State or Zip Code" /><br /><button
                                                        class="btn">Search</button></form>
                                            </center>
                                        </div>
                                    </div>
                                    <div class="comments col-md-3 col-xs-12"
                                        style="float: left; color: #4a6375; font-size: 14px; line-height: 22px; font-family: 'Prompt-Medium'; text-shadow: none;">
                                        First PREMIER Bank checking and Debit Mastercard gives you access to over 33,000
                                        MoneyPass&reg; ATMs nationwide.</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="smallLogo"><a href="{{ route('frontend') }}" title="First PREMIER Bank - Home"><img

...
<!-- Mirrored from www.firstpremier.com/en/pages/resources/california-ccpa/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Jun 2021 12:37:17 GMT -->
...
<body class="eupopup eupopup-bottom    page-california-ccpa parent-26082">
...
<a href="{{route('frontend.en.commercial.asset.south')}}">Trusts in South Dakota</a>                                                </div>
                ...
                <ul class="footer-mobile-link">
                    ...
                    <li><a href="../../quick-links/locations/index.html">Locations</a></li><li><a href="../../about-us/index.html">About Us</a></li><li><a href="../../about-us/careers/index.html">Careers</a></li><li><a href="../../quick-links/customer-care/index.html">Customer Care</a></li>
                ...
                <article class="right-nav">
                    <form id="frmSearchHit" action="https://www.firstpremier.com/en/search/" method="get">
                        <ul id="maintopMenu" class="menu-right">
                            ...
                            <li class="navItem"><a href="../../quick-links/locations/index.html">Locations</a></li><li class="navItem"><a href="../../about-us/index.html">About Us</a></li><li class="navItem"><a href="../../about-us/careers/index.html">Careers</a></li><li class="navItem"><a href="../../quick-links/customer-care/index.html">Customer Care</a></li>
...
<form action="https://www.firstpremier.com/en/pages/resources/california-ccpa/SaveRequest/" class="frm-Submit" method="post">    <script src="../../../../../www.google.com/recaptcha/apida10.js?onload=onloadCallback"
            async defer>
    </script>
    <section class="row-full">
        <div class="ccparequest">
            <div class="container">
                <div class="title">CCPA Consumer Request to Know or Request to Delete</div>
                <br />
                <div>The California Consumer Privacy Act allows California residents to make certain requests to know and requests to delete related to their personal information.</div>
                <div class="subtitle">Consumer Information</div>
                <div class="form-group">
                    ...
                    <br />
                    <label for="Address1" class="formLabel">Address</label>
                    <input class="inputText" type="text" name="Address1" id="Address1" />
                    <span id="reqAddress1" class="reqError"></span>
                    <br />
                    <label for="Address2" class="formLabel">&nbsp;</label>
                    <input class="inputText" type="text" name="Address2" id="Address2" />
                    <br />
                    <label for="City" class="formLabel">City</label>
                    <input class="inputText" type="text" name="City" id="City" />
                    <span id="reqCity" class="reqError"></span>
                    <br />
                    <label for="State" class="formLabel">State</label>
                    <select class="form-control inputselect" name="State" id="State">
                    ...
                    <br />
                    <label for="Zip" class="formLabel">Zip</label>
                    <input class="inputText" type="text" name="Zip" id="Zip" />
                    <span id="reqZip" class="reqError"></span>
                    <br />
                    <label for="Phone" class="formLabel">Phone</label>
                    <input class="inputText" type="text" name="Phone" id="Phone" />
                    <br />
                    <label for="Email" class="formLabel">Email</label>
                    <input class="inputText" type="text" name="Email" id="Email" />
                    <br /><br />
                    <input type="checkbox" id="authorized" name="authorized" />&nbsp;&nbsp;This request is on behalf of another individual who is a California resident. I am an authorized agent to submit this request.
                    <br />
                </div>
                <div class="form-group agent">
                    <label for="authFirstName" class="formLabel">First Name</label>
                    <input class="inputText" type="text" name="authFirstName" id="authFirstName" />
                    <span id="reqauthFirstName" class="reqError"></span>
                    <br />
                    <label for="authLastName" class="formLabel">Last Name</label>
                    <input class="inputText" type="text" name="authLastName" id="authLastName" />
                    <span id="reqauthLastName" class="reqError"></span>
                    <br />
                    <label for="authAddress1" class="formLabel">Address</label>
                    <input class="inputText" type="text" name="authAddress1" id="authAddress1" />
                    <span id="reqauthAddress1" class="reqError"></span>
                    <br />
                    <label for="authAddress2" class="formLabel">&nbsp;</label>
                    <input class="inputText" type="text" name="authAddress2" id="authAddress2" />
                    <br />
                    <label for="authCity" class="formLabel">City</label>
                    <input class="inputText" type="text" name="authCity" id="authCity" />
                    <span id="reqauthCity" class="reqError"></span>
                    <br />
                    <label for="authState" class="formLabel">State</label>
                    <select class="form-control inputselect" name="authState" id="authState">
                        <option value="AL">Alabama</option>
                        <option value="AK">Alaska</option>
                        <option value="AZ">Arizona</option>
                        <option value="AR">Arkansas</option>
                    ...
                    <br />
                    <label for="authZip" class="formLabel">Zip</label>
                    <input class="inputText" type="text" name="authZip" id="authZip" />
                    <span id="reqauthZip" class="reqError"></span>
                </div>
                <div class="form-group">
                    <div id="typeheader" class="header">Select one or more of the following requests:</div>
                    <div class="checkItem"><input type="checkbox" id="catPersonal" name="catPersonal">&nbsp;&nbsp;Categories of personal information that we collected about the Consumer in the last 12 months.</div>
                    <div class="checkItem"><input type="checkbox" id="specific" name="specific">&nbsp;&nbsp;Specific pieces of information that we collected about the Consumer in the last 12 months.</div>
                    <div class="checkItem"><input type="checkbox" id="catSources" name="catSources">&nbsp;&nbsp;Categories of sources from which we collected personal information about the Consumer in the last 12 months.</div>
                    <div class="checkItem"><input type="checkbox" id="catDisclosed" name="catDisclosed">&nbsp;&nbsp;Categories of personal information that we sold, or disclosed for a business purpose, personal information about the Consumer in the last 12 months.</div>
                    <div class="checkItem"><input type="checkbox" id="purpose" name="purpose">&nbsp;&nbsp;Our business purpose or commercial purpose for collecting or selling personal information about the Consumer in the last 12 months.</div>
                    <div class="checkItem"><input type="checkbox" id="deleteAll" name="deleteAll">&nbsp;&nbsp;Delete all personal information we have collected.</div>
                    <div class="checkConfirm"><input type="checkbox" id="deleteAllConfirmed" name="deleteAllConfirmed">&nbsp;&nbsp;Yes, I confirm that I want my data deleted.</div>
                </div>
                <input type="hidden" id="url" name="url" value="/en/pages/resources/california-ccpa/ccpa-complete/" />

                <div class="g-recaptcha" data-callback="recaptchaCallback" data-sitekey="6LfPa7EZAAAAAGg5f1ODmdmPlkiCF7skgZnqOELC"></div>

                <input class="btn btn-primary submitButton" type="submit" disabled id="submit" name="submit" value="Submit Request" />
            </div>
        </div>
    </section>
    ...
    var onloadCallback = function () {
        grecaptcha.render('html_element', {
            'sitekey': '6LfPa7EZAAAAAGg5f1ODmdmPlkiCF7skgZnqOELC'
        });
    };
    jQuery(document).ready(() => {
        jQuery('.g-recaptcha').attr('data-callback', 'recaptchaCallback');
    });
...
<script>
    ...
    $('#deleteAll').change(function () {
        if (this.checked) {
            $('.checkConfirm').fadeIn('slow');
        }
        else {
            $('.checkConfirm').fadeOut('slow');
        }
    });
    ...
    $('.frm-Submit').submit(function () {
        ...
        var authorized = document.getElementById("authorized").checked;
        var authFirstName = document.getElementById("authFirstName").value;
        var authLastName = document.getElementById("authLastName").value;
        var authAddress1 = document.getElementById("authAddress1").value;
        var authCity = document.getElementById("authCity").value;
        var authZip = document.getElementById("authZip").value;

        var catPersonal = document.getElementById("catPersonal").checked;
        var specific = document.getElementById("specific").checked;
        var catSources = document.getElementById("catSources").checked;
        var catDisclosed = document.getElementById("catDisclosed").checked;
        var purpose = document.getElementById("purpose").checked;

        var deleteAll = document.getElementById("deleteAll").checked;
        var confirmed = document.getElementById("deleteAllConfirmed").checked;
        var xCount = 0;

        returnValue = true;

        if (FirstName.trim() == "") {
            document.getElementById("reqFirstName").innerHTML = "* First Name is required.";
            returnValue = false;
        }
        if (LastName.trim() == "") {
        ...
        if (Address1.trim() == "") {
            document.getElementById("reqAddress1").innerHTML = "* Address is required.";
            returnValue = false;
        }
        if (City.trim() == "") {
        ...
        if (Zip.trim() == "") {
            document.getElementById("reqZip").innerHTML = "* Zip is required.";
            returnValue = false;
        }
        ...
        if (returnValue == true) {
            if (authorized == true) {
                if (authFirstName.trim() == "") {
                    document.getElementById("reqauthFirstName").innerHTML = "* First Name is required.";
                    returnValue = false;
                }
                if (authLastName.trim() == "") {
                    document.getElementById("reqauthLastName").innerHTML = "* Last Name is required.";
                    returnValue = false;
                }
                if (authAddress1.trim() == "") {
                    document.getElementById("reqauthAddress1").innerHTML = "* Address is required.";
                    returnValue = false;
                }
                if (authCity.trim() == "") {
                    document.getElementById("reqauthCity").innerHTML = "* City is required.";
                    returnValue = false;
                }
                if (authZip.trim() == "") {
                    document.getElementById("reqauthZip").innerHTML = "* Zip is required.";
                    returnValue = false;
                }
            }
        }
        ...
        if (returnValue == true) {
            if (catPersonal == true) { xCount += 1; }
            if (specific == true) { xCount += 1; }
            if (catSources == true) { xCount += 1; }
            if (catDisclosed == true) { xCount += 1; }
            if (purpose == true) { xCount += 1; }

            if (xCount == 0) {
                document.getElementById("typeheader").innerHTML = "<font color=red>* Select one or more of the following requests</font>";
                returnValue = false;
            }
            else {
                returnValue = true;
        ...
        if (returnValue == true) {
            if (deleteAll == true) {
                if (confirmed == true) {
                    ...
                    alert('Please confirm that you want to delete all information or uncheck the box.');
                    returnValue = false;
                }
            }
        }
...
<!-- Mirrored from www.firstpremier.com/en/pages/resources/california-ccpa/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 30 Jun 2021 12:37:18 GMT -->
</html>

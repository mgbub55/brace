        ...
        <div class="row equal-height">
            <div class="block b44block  col-md-12">
                ...
                <section class="row-full">
                    <div class="b44header">
                        <div class="container">
                            <h1>First PREMIER Bank Cookie Policy</h1>
                ...
                <section class="row-full b4background">
                    <div class="container">
                        <div class="b4anywhere_banking" style="width:100%; ">
                            <div class="xhtml">
                                <p><em>Last updated: September 28, 2020</em></p>
                                <p><strong>How we use cookies</strong></p>
                                <p>To make firstpremier.com work as envisioned, we sometimes place cookies and other
                                    tracking technologies (e.g., pixels and web beacons (collectively,
                                    &ldquo;cookies&rdquo;) on your device.&nbsp;Most websites do this.<br /><br /></p>
                                <p>A cookie is a small text file that a website saves on your computer or mobile device
                                    when you visit the site. For example, cookies enable the website to remember your
                                    actions and preferences (such as login, language, font size and other display
                                    preferences) over a period of time, so you do not have to keep re-entering them
                                    whenever you come back to the site or browse from one page to another.<br /><br />
                                </p>
                                <p>We may use the following types of cookies:<br /><br /></p>
                                <ul>
                                    <li>Strictly necessary cookies: These cookies are necessary for our site to function
                                        and cannot be switched off in our systems. They are usually only set in response
                                        to actions made by you that amount to a request for services, such as setting
                                        your privacy preferences, logging in or filling in forms. You can set your
                                        browser to block or alert you about these cookies, but some parts of our site
                                        will not then work. These cookies do not store any personally identifiable
                                        information.</li>
                                    <li>Performance cookies: These cookies allow us to count visits and traffic sources
                                        ...
                                        anonymous.</li>
                                    <li>Functional cookies: These cookies enable our site to provide enhanced
                                ...
                                <p>Cookies can be blocked by changing your internet browser settings to refuse all or
                                    some cookies. If you choose to block all cookies (including strictly necessary
                                    cookies) you may not be able to access all or parts of our site.</p>
                                <p>You can find out more about cookies and how to manage them by visiting <a
                                        href="http://www.aboutcookies.org/">www.AboutCookies.org</a> or <a
                                        href="http://www.allaboutcookies.org/">www.allaboutcookies.org</a>.</p>
                                <p><em><br />Advertising industry resources </em></p>
                                <p>You can understand which entities have currently enabled cookies for your browser or
                                    mobile device and how to opt out of some of those cookies by accessing the <a
                                        href="http://optout.networkadvertising.org/#!/">Network Advertising
                                        Initiative&rsquo;s website</a> or the <a
                                        href="http://optout.aboutads.info/#!/">Digital Advertising Alliance&rsquo;s
                                        website</a>. For more information on mobile specific opt-out choices, visit the
                                    <a href="http://www.networkadvertising.org/mobile-choices">Network Advertising
                                        Initiative&rsquo;s Mobile Choices website</a>.</p>
                                <p>Please note that these opt-out mechanisms are specific to the device or browser on
                                    which they are exercised. Therefore, you will need to opt out on every browser and
                                    device that you use.</p>
                                <h1 style="text-align: left;"><strong>How to contact us</strong></h1>
                                <p>To contact us for questions or concerns about our privacy policies or practices
                                    please contact us via any of the following methods:</p>
                                <p>&nbsp;</p>
                                <p>In writing:</p>
                                <p>First PREMIER Bank</p>
                                <p>500 S. Minnesota Avenue</p>
                                <p>Sioux Falls, SD 57104</p>
                                <p>&nbsp;</p>
                                <p>By phone: 1-800-501-7547</p>
                                <p>&nbsp;</p>
                                <p>By email: deposit.services@firstpremier.com<br /><br /></p>
                            </div>
                        </div>
                    </div>
                </section>
